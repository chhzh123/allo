...
module {
  ...
  func.func @feed_2_up_load(%arg0: memref<4x4xi8, #map>, %arg1: index, %arg2: !allo.stream<memref<4xi8>, 16>) attributes {df.kernel, itypes = "s__", otypes = ""} {
    %c0_i8 = arith.constant 0 : i8
    affine.for %arg3 = 0 to 4 {
      %alloc = memref.alloc() {name = "_blk"} : memref<4xi8>
      affine.for %arg4 = 0 to 4 {
  ...
  func.func @pe_c_out_drain(%arg0: memref<4x4xi32, #map>, %arg1: index, %arg2: !allo.stream<i32, 4>) attributes {df.kernel, itypes = "s__", otypes = ""} {
    affine.for %arg3 = 0 to 4 {
  ...
  func.func @top(%arg0: memref<4x4xi8, #map>, %arg1: memref<4x4xi8, #map>, %arg2: memref<4x4xi32, #map>) attributes {dataflow, itypes = "sss", otypes = "", top} {
    ...
    call @feed_up_load(%arg0, %c0, %55) : (memref<4x4xi8, #map>, index, !allo.stream<memref<4xi8>, 16>) -> ()
    call @feed_2_up_load(%arg1, %c0, %54) : (memref<4x4xi8, #map>, index, !allo.stream<memref<4xi8>, 16>) -> ()
    call @pe_r4(%c0, %c0, %53, %52, %51, %50, %49) : (index, index, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r0(%c0, %c1, %48, %47, %46, %45, %52) : (index, index, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r0(%c0, %c2, %44, %43, %42, %41, %47) : (index, index, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r5(%c0, %c3, %40, %39, %38, %43) : (index, index, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r6(%c1, %c0, %53, %37, %36, %50, %35, %34) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r1(%c1, %c1, %48, %33, %32, %45, %31, %36) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r1(%c1, %c2, %44, %30, %29, %41, %28, %32) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r7(%c1, %c3, %40, %27, %38, %26, %29) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r8(%c2, %c0, %37, %25, %24, %35, %23, %22) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r2(%c2, %c1, %33, %21, %20, %31, %19, %24) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r2(%c2, %c2, %30, %18, %17, %28, %16, %20) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r9(%c2, %c3, %27, %15, %26, %14, %17) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    call @pe_r10(%c3, %c0, %25, %13, %12, %23, %11) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 4>, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    ...
    call @pe_r11(%c3, %c3, %15, %6, %14, %7) : (index, index, !allo.stream<i32, 2>, !allo.stream<i32, 4>, !allo.stream<i8, 2>, !allo.stream<i8, 2>) -> ()
    ...
    call @pe_c_out_drain(%arg2, %c0, %13) : (memref<4x4xi32, #map>, index, !allo.stream<i32, 4>) -> ()
    call @pe_c_out_drain(%arg2, %c1, %10) : (memref<4x4xi32, #map>, index, !allo.stream<i32, 4>) -> ()
    call @pe_c_out_drain(%arg2, %c2, %8) : (memref<4x4xi32, #map>, index, !allo.stream<i32, 4>) -> ()
    call @pe_c_out_drain(%arg2, %c3, %6) : (memref<4x4xi32, #map>, index, !allo.stream<i32, 4>) -> ()
    return
  }
}
