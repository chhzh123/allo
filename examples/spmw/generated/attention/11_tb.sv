...
module tb;
  ...
  initial begin
    ...
    mac_a_in_bind_src0[2] = 8'h01;
    mac_a_in_bind_src0[3] = 8'h01;
    mac_a_in_bind_src0[4] = 8'h00;
    mac_a_in_bind_src0[5] = 8'h01;
  end
  ...
  initial begin
    mac_a_in_bind_src1[0] = 8'h00;
    mac_a_in_bind_src1[1] = 8'h01;
    mac_a_in_bind_src1[2] = 8'h00;
    mac_a_in_bind_src1[3] = 8'h02;
    mac_a_in_bind_src1[4] = 8'h00;
    mac_a_in_bind_src1[5] = 8'h00;
  end
  ...
  initial begin
    ...
    mac_a_in_bind_src2[1] = 8'h02;
    mac_a_in_bind_src2[2] = 8'h01;
    mac_a_in_bind_src2[3] = 8'h02;
    mac_a_in_bind_src2[4] = 8'h02;
    mac_a_in_bind_src2[5] = 8'h00;
  end
  ...
  initial begin
    ...
    mac_a_in_bind_src3[1] = 8'h01;
    mac_a_in_bind_src3[2] = 8'h02;
    mac_a_in_bind_src3[3] = 8'h02;
    mac_a_in_bind_src3[4] = 8'h00;
    mac_a_in_bind_src3[5] = 8'h02;
  end
  ...
  reg [7:0] mac_a_in_bind_src4 [0:5];
  integer mac_a_in_bind_p4 = 0;
  initial begin
    mac_a_in_bind_src4[0] = 8'h01;
    mac_a_in_bind_src4[1] = 8'h01;
    mac_a_in_bind_src4[2] = 8'h01;
    mac_a_in_bind_src4[3] = 8'h01;
    mac_a_in_bind_src4[4] = 8'h00;
    mac_a_in_bind_src4[5] = 8'h00;
  end
  assign mac_a_in_bind_dout[4] = mac_a_in_bind_src4[mac_a_in_bind_p4 < 6 ? mac_a_in_bind_p4 : 5];
  assign mac_a_in_bind_empty_n[4] = (mac_a_in_bind_p4 < 6);
  always @(posedge clk) if (rst_n && mac_a_in_bind_read[4] && mac_a_in_bind_empty_n[4]) mac_a_in_bind_p4 <= mac_a_in_bind_p4 + 1;
  reg [7:0] mac_a_in_bind_src5 [0:5];
  integer mac_a_in_bind_p5 = 0;
  initial begin
    mac_a_in_bind_src5[0] = 8'h00;
    mac_a_in_bind_src5[1] = 8'h02;
    mac_a_in_bind_src5[2] = 8'h02;
    mac_a_in_bind_src5[3] = 8'h02;
    mac_a_in_bind_src5[4] = 8'h01;
    mac_a_in_bind_src5[5] = 8'h01;
  end
  assign mac_a_in_bind_dout[5] = mac_a_in_bind_src5[mac_a_in_bind_p5 < 6 ? mac_a_in_bind_p5 : 5];
  assign mac_a_in_bind_empty_n[5] = (mac_a_in_bind_p5 < 6);
  always @(posedge clk) if (rst_n && mac_a_in_bind_read[5] && mac_a_in_bind_empty_n[5]) mac_a_in_bind_p5 <= mac_a_in_bind_p5 + 1;
  reg [7:0] mac_a_in_bind_src6 [0:5];
  integer mac_a_in_bind_p6 = 0;
  initial begin
    mac_a_in_bind_src6[0] = 8'h00;
    mac_a_in_bind_src6[1] = 8'h02;
    mac_a_in_bind_src6[2] = 8'h02;
    mac_a_in_bind_src6[3] = 8'h00;
    mac_a_in_bind_src6[4] = 8'h01;
    mac_a_in_bind_src6[5] = 8'h00;
  end
  assign mac_a_in_bind_dout[6] = mac_a_in_bind_src6[mac_a_in_bind_p6 < 6 ? mac_a_in_bind_p6 : 5];
  assign mac_a_in_bind_empty_n[6] = (mac_a_in_bind_p6 < 6);
  always @(posedge clk) if (rst_n && mac_a_in_bind_read[6] && mac_a_in_bind_empty_n[6]) mac_a_in_bind_p6 <= mac_a_in_bind_p6 + 1;
  reg [7:0] mac_a_in_bind_src7 [0:5];
  integer mac_a_in_bind_p7 = 0;
  initial begin
    mac_a_in_bind_src7[0] = 8'h00;
    mac_a_in_bind_src7[1] = 8'h02;
    mac_a_in_bind_src7[2] = 8'h00;
    mac_a_in_bind_src7[3] = 8'h00;
    mac_a_in_bind_src7[4] = 8'h01;
    mac_a_in_bind_src7[5] = 8'h01;
  end
  assign mac_a_in_bind_dout[7] = mac_a_in_bind_src7[mac_a_in_bind_p7 < 6 ? mac_a_in_bind_p7 : 5];
  assign mac_a_in_bind_empty_n[7] = (mac_a_in_bind_p7 < 6);
  always @(posedge clk) if (rst_n && mac_a_in_bind_read[7] && mac_a_in_bind_empty_n[7]) mac_a_in_bind_p7 <= mac_a_in_bind_p7 + 1;
  ...
  initial begin
    act_y_out_bind_exp1[0] = 8'h01;
    act_y_out_bind_exp1[1] = 8'h04;
    act_y_out_bind_exp1[2] = 8'h03;
    act_y_out_bind_exp1[3] = 8'h03;
    act_y_out_bind_exp1[4] = 8'h01;
    act_y_out_bind_exp1[5] = 8'h01;
  end
