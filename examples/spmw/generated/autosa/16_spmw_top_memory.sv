...
module spmw_top (
  ...
  endgenerate
  // family pe_c_out_bind: 4 channel(s), 32-bit, depth 4
  ...
  generate
    for (pe_c_out_bind_i = 0; pe_c_out_bind_i < 4; pe_c_out_bind_i = pe_c_out_bind_i + 1) begin : g_pe_c_out_bind
      spmw_fifo #(.DW(32), .DEPTH(4)) u (.clk(ap_clk), .rst_n(ap_rst_n), .din(pe_c_out_bind_din[pe_c_out_bind_i]), .full_n(pe_c_out_bind_full_n[pe_c_out_bind_i]), .write(pe_c_out_bind_write[pe_c_out_bind_i]), .dout(pe_c_out_bind_dout[pe_c_out_bind_i]), .empty_n(pe_c_out_bind_empty_n[pe_c_out_bind_i]), .read(pe_c_out_bind_read[pe_c_out_bind_i]));
    end
  endgenerate
  ...
  endgenerate
  // family feed_2_up_bind: 1 channel(s), 32-bit, depth 16
  ...
  generate
    for (feed_2_up_bind_i = 0; feed_2_up_bind_i < 1; feed_2_up_bind_i = feed_2_up_bind_i + 1) begin : g_feed_2_up_bind
      spmw_fifo #(.DW(32), .DEPTH(16)) u (.clk(ap_clk), .rst_n(ap_rst_n), .din(feed_2_up_bind_din[feed_2_up_bind_i]), .full_n(feed_2_up_bind_full_n[feed_2_up_bind_i]), .write(feed_2_up_bind_write[feed_2_up_bind_i]), .dout(feed_2_up_bind_dout[feed_2_up_bind_i]), .empty_n(feed_2_up_bind_empty_n[feed_2_up_bind_i]), .read(feed_2_up_bind_read[feed_2_up_bind_i]));
    end
  endgenerate
  ...
  wire [31:0] pe_pid0_dout [0:15];
  wire pe_pid0_empty_n [0:15];
  wire pe_pid0_read [0:15];
  ...
  spmw_const #(.DW(32), .VAL(1)) u_pe_pid0_4 (.dout(pe_pid0_dout[4]), .empty_n(pe_pid0_empty_n[4]), .read(pe_pid0_read[4]));
  spmw_const #(.DW(32), .VAL(1)) u_pe_pid0_5 (.dout(pe_pid0_dout[5]), .empty_n(pe_pid0_empty_n[5]), .read(pe_pid0_read[5]));
  spmw_const #(.DW(32), .VAL(1)) u_pe_pid0_6 (.dout(pe_pid0_dout[6]), .empty_n(pe_pid0_empty_n[6]), .read(pe_pid0_read[6]));
  spmw_const #(.DW(32), .VAL(1)) u_pe_pid0_7 (.dout(pe_pid0_dout[7]), .empty_n(pe_pid0_empty_n[7]), .read(pe_pid0_read[7]));
  spmw_const #(.DW(32), .VAL(2)) u_pe_pid0_8 (.dout(pe_pid0_dout[8]), .empty_n(pe_pid0_empty_n[8]), .read(pe_pid0_read[8]));
  spmw_const #(.DW(32), .VAL(2)) u_pe_pid0_9 (.dout(pe_pid0_dout[9]), .empty_n(pe_pid0_empty_n[9]), .read(pe_pid0_read[9]));
  spmw_const #(.DW(32), .VAL(2)) u_pe_pid0_10 (.dout(pe_pid0_dout[10]), .empty_n(pe_pid0_empty_n[10]), .read(pe_pid0_read[10]));
  spmw_const #(.DW(32), .VAL(2)) u_pe_pid0_11 (.dout(pe_pid0_dout[11]), .empty_n(pe_pid0_empty_n[11]), .read(pe_pid0_read[11]));
  spmw_const #(.DW(32), .VAL(3)) u_pe_pid0_12 (.dout(pe_pid0_dout[12]), .empty_n(pe_pid0_empty_n[12]), .read(pe_pid0_read[12]));
  spmw_const #(.DW(32), .VAL(3)) u_pe_pid0_13 (.dout(pe_pid0_dout[13]), .empty_n(pe_pid0_empty_n[13]), .read(pe_pid0_read[13]));
  spmw_const #(.DW(32), .VAL(3)) u_pe_pid0_14 (.dout(pe_pid0_dout[14]), .empty_n(pe_pid0_empty_n[14]), .read(pe_pid0_read[14]));
  spmw_const #(.DW(32), .VAL(3)) u_pe_pid0_15 (.dout(pe_pid0_dout[15]), .empty_n(pe_pid0_empty_n[15]), .read(pe_pid0_read[15]));
