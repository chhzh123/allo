module {
  ...
  func.func @top(%arg0: memref<4x4xi8>, %arg1: memref<5x4xi32>, %arg2: memref<17xi32>, %arg3: memref<4x4x4xi8>, %arg4: memref<4x2xi32>, %arg5: memref<4x4xi32>) attributes {dataflow, itypes = "ssssss", otypes = ""} {
    ...
    call @mac_a_in_load(%arg0, %c0, %55) : (memref<4x4xi8>, index, !allo.stream<i8, 4>) -> ()
    call @mac_a_in_load(%arg0, %c1, %54) : (memref<4x4xi8>, index, !allo.stream<i8, 4>) -> ()
    call @mac_a_in_load(%arg0, %c2, %53) : (memref<4x4xi8>, index, !allo.stream<i8, 4>) -> ()
    call @mac_a_in_load(%arg0, %c3, %52) : (memref<4x4xi8>, index, !allo.stream<i8, 4>) -> ()
    call @mac_op_in_load(%arg1, %c0, %51) : (memref<5x4xi32>, index, !allo.stream<i32, 5>) -> ()
    call @mac_op_in_load(%arg1, %c1, %50) : (memref<5x4xi32>, index, !allo.stream<i32, 5>) -> ()
    call @mac_op_in_load(%arg1, %c2, %49) : (memref<5x4xi32>, index, !allo.stream<i32, 5>) -> ()
    call @mac_op_in_load(%arg1, %c3, %48) : (memref<5x4xi32>, index, !allo.stream<i32, 5>) -> ()
    call @vpu_op_in_load(%arg2, %c0, %47) : (memref<17xi32>, index, !allo.stream<i32, 17>) -> ()
    call @mac_r8(%arg3, %c0, %c0, %55, %46, %51, %45, %44) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 4>, !allo.stream<i8, 2>, !allo.stream<i32, 5>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    ...
    call @mac_r4(%arg3, %c1, %c0, %54, %36, %50, %35, %44, %34) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 4>, !allo.stream<i8, 2>, !allo.stream<i32, 5>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    ...
    call @mac_r4(%arg3, %c2, %c0, %53, %26, %49, %25, %34, %24) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 4>, !allo.stream<i8, 2>, !allo.stream<i32, 5>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    ...
    call @mac_r7(%arg3, %c3, %c0, %52, %16, %48, %15, %24, %14) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 4>, !allo.stream<i8, 2>, !allo.stream<i32, 5>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
