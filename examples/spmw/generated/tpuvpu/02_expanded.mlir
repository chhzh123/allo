module {
  ...
  func.func @top(%arg0: memref<6x4xi8>, %arg1: memref<8xi32>, %arg2: memref<4x4xi8>, %arg3: memref<4xi32>, %arg4: memref<6x4xi32>) attributes {dataflow, itypes = "sssss", otypes = ""} {
    ...
    call @mac_a_in_load(%arg0, %c0, %39) : (memref<6x4xi8>, index, !allo.stream<i8, 6>) -> ()
    call @mac_a_in_load(%arg0, %c1, %38) : (memref<6x4xi8>, index, !allo.stream<i8, 6>) -> ()
    call @mac_a_in_load(%arg0, %c2, %37) : (memref<6x4xi8>, index, !allo.stream<i8, 6>) -> ()
    call @mac_a_in_load(%arg0, %c3, %36) : (memref<6x4xi8>, index, !allo.stream<i8, 6>) -> ()
    call @vpu_op_in_load(%arg1, %c0, %35) : (memref<8xi32>, index, !allo.stream<i32, 8>) -> ()
    call @mac_r8(%arg2, %c0, %c0, %39, %34, %33) : (memref<4x4xi8>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r2(%arg2, %c0, %c1, %34, %32, %31) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r2(%arg2, %c0, %c2, %32, %30, %29) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r6(%arg2, %c0, %c3, %30, %28) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r4(%arg2, %c1, %c0, %38, %27, %33, %26) : (memref<4x4xi8>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg2, %c1, %c1, %27, %25, %31, %24) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg2, %c1, %c2, %25, %23, %29, %22) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r3(%arg2, %c1, %c3, %23, %28, %21) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r4(%arg2, %c2, %c0, %37, %20, %26, %19) : (memref<4x4xi8>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg2, %c2, %c1, %20, %18, %24, %17) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg2, %c2, %c2, %18, %16, %22, %15) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r3(%arg2, %c2, %c3, %16, %21, %14) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r7(%arg2, %c3, %c0, %36, %13, %19, %12) : (memref<4x4xi8>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r1(%arg2, %c3, %c1, %13, %11, %17, %10) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r1(%arg2, %c3, %c2, %11, %9, %15, %8) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r5(%arg2, %c3, %c3, %9, %14, %7) : (memref<4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @vpu_r2(%arg3, %c0, %35, %6, %5, %12) : (memref<4xi32>, index, !allo.stream<i32, 8>, !allo.stream<i32, 2>, !allo.stream<i32, 6>, !allo.stream<i32, 2>) -> ()
    call @vpu_r0(%arg3, %c1, %6, %4, %3, %10) : (memref<4xi32>, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 6>, !allo.stream<i32, 2>) -> ()
    call @vpu_r0(%arg3, %c2, %4, %2, %1, %8) : (memref<4xi32>, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 6>, !allo.stream<i32, 2>) -> ()
    call @vpu_r1(%arg3, %c3, %2, %0, %7) : (memref<4xi32>, index, !allo.stream<i32, 2>, !allo.stream<i32, 6>, !allo.stream<i32, 2>) -> ()
    call @vpu_y_out_drain(%arg4, %c0, %5) : (memref<6x4xi32>, index, !allo.stream<i32, 6>) -> ()
    call @vpu_y_out_drain(%arg4, %c1, %3) : (memref<6x4xi32>, index, !allo.stream<i32, 6>) -> ()
    call @vpu_y_out_drain(%arg4, %c2, %1) : (memref<6x4xi32>, index, !allo.stream<i32, 6>) -> ()
    call @vpu_y_out_drain(%arg4, %c3, %0) : (memref<6x4xi32>, index, !allo.stream<i32, 6>) -> ()
    return
  }
}
