...
module tb;
  ...
  reg [31:0] vpu_op_in_bind_src0 [0:7];
  integer vpu_op_in_bind_p0 = 0;
  initial begin
    vpu_op_in_bind_src0[0] = 32'h01000000;
    vpu_op_in_bind_src0[1] = 32'h02100000;
    vpu_op_in_bind_src0[2] = 32'h04010000;
    vpu_op_in_bind_src0[3] = 32'h03200000;
    vpu_op_in_bind_src0[4] = 32'h06020000;
    vpu_op_in_bind_src0[5] = 32'h07000004;
    vpu_op_in_bind_src0[6] = 32'h08000000;
    vpu_op_in_bind_src0[7] = 32'h00000000;
  end
  assign vpu_op_in_bind_dout[0] = vpu_op_in_bind_src0[vpu_op_in_bind_p0 < 8 ? vpu_op_in_bind_p0 : 7];
  assign vpu_op_in_bind_empty_n[0] = (vpu_op_in_bind_p0 < 8);
  always @(posedge clk) if (rst_n && vpu_op_in_bind_read[0] && vpu_op_in_bind_empty_n[0]) vpu_op_in_bind_p0 <= vpu_op_in_bind_p0 + 1;
  wire [31:0] vpu_b_mem_dout [0:3];
  wire vpu_b_mem_empty_n [0:3];
  wire vpu_b_mem_read [0:3];
  reg [31:0] vpu_b_mem_src0 [0:0];
  integer vpu_b_mem_p0 = 0;
  initial begin
    vpu_b_mem_src0[0] = 32'h00000001;
  end
  ...
  reg [31:0] vpu_b_mem_src1 [0:0];
  integer vpu_b_mem_p1 = 0;
  initial begin
    vpu_b_mem_src1[0] = 32'h00000000;
  end
  ...
  reg [31:0] vpu_b_mem_src2 [0:0];
  integer vpu_b_mem_p2 = 0;
  initial begin
    vpu_b_mem_src2[0] = 32'h00000000;
  end
  ...
  reg [31:0] vpu_b_mem_src3 [0:0];
  integer vpu_b_mem_p3 = 0;
  initial begin
    vpu_b_mem_src3[0] = 32'h00000000;
  end
  ...
  reg [31:0] vpu_y_out_bind_exp0 [0:5];
  ...
  initial begin
    ...
    vpu_y_out_bind_exp0[4] = 32'h00000000;
    vpu_y_out_bind_exp0[5] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[0] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[0]) begin
    if (vpu_y_out_bind_q0 < 6) begin
  ...
  reg [31:0] vpu_y_out_bind_exp1 [0:5];
  ...
  initial begin
    ...
    vpu_y_out_bind_exp1[4] = 32'h00000000;
    vpu_y_out_bind_exp1[5] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[1] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[1]) begin
    if (vpu_y_out_bind_q1 < 6) begin
  ...
  reg [31:0] vpu_y_out_bind_exp2 [0:5];
  ...
  initial begin
    ...
    vpu_y_out_bind_exp2[4] = 32'h00000000;
    vpu_y_out_bind_exp2[5] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[2] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[2]) begin
    if (vpu_y_out_bind_q2 < 6) begin
  ...
  reg [31:0] vpu_y_out_bind_exp3 [0:5];
  ...
  initial begin
    ...
    vpu_y_out_bind_exp3[4] = 32'h00000000;
    vpu_y_out_bind_exp3[5] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[3] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[3]) begin
    if (vpu_y_out_bind_q3 < 6) begin
