...
module tb;
  ...
  reg [31:0] pe_west_bind_src0 [0:2];
  ...
  reg [31:0] pe_west_bind_src1 [0:2];
  ...
  reg [31:0] pe_west_bind_src2 [0:2];
  integer pe_west_bind_p2 = 0;
  initial begin
    pe_west_bind_src2[0] = 32'h00000000;
    pe_west_bind_src2[1] = 32'h00000000;
    pe_west_bind_src2[2] = 32'h00000000;
  end
  ...
  wire [31:0] pe_north_bind_dout [0:2];
  wire pe_north_bind_empty_n [0:2];
  wire pe_north_bind_read [0:2];
  reg [31:0] pe_north_bind_src0 [0:2];
  integer pe_north_bind_p0 = 0;
  initial begin
    pe_north_bind_src0[0] = 32'h40000000;
    pe_north_bind_src0[1] = 32'h3f800000;
    pe_north_bind_src0[2] = 32'h40000000;
  end
  ...
  reg [31:0] pe_north_bind_src1 [0:2];
  integer pe_north_bind_p1 = 0;
  initial begin
    pe_north_bind_src1[0] = 32'h3f800000;
    pe_north_bind_src1[1] = 32'h3f800000;
    pe_north_bind_src1[2] = 32'h3f800000;
  end
  ...
  reg [31:0] pe_north_bind_src2 [0:2];
  integer pe_north_bind_p2 = 0;
  initial begin
    pe_north_bind_src2[0] = 32'h40000000;
    pe_north_bind_src2[1] = 32'h40000000;
    pe_north_bind_src2[2] = 32'h3f800000;
  end
  ...
  always @(posedge clk) if (rst_n && pe_c_mem_write[4]) begin
    if (pe_c_mem_q4 < 1) begin
      if (((($bitstoshortreal(pe_c_mem_din[4][31:0])) - ($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])) : ($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])))) || ((($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])) - ($bitstoshortreal(pe_c_mem_din[4][31:0]))) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])) : ($bitstoshortreal(pe_c_mem_exp4[pe_c_mem_q4][31:0])))))) begin
        errors = errors + 1;
        $display("MISMATCH pe_c_mem[%0d] step %0d: got %h want %h",
  ...
  always @(posedge clk) if (rst_n && pe_c_mem_write[5]) begin
    if (pe_c_mem_q5 < 1) begin
      if (((($bitstoshortreal(pe_c_mem_din[5][31:0])) - ($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])) : ($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])))) || ((($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])) - ($bitstoshortreal(pe_c_mem_din[5][31:0]))) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])) : ($bitstoshortreal(pe_c_mem_exp5[pe_c_mem_q5][31:0])))))) begin
        errors = errors + 1;
        $display("MISMATCH pe_c_mem[%0d] step %0d: got %h want %h",
  ...
  always @(posedge clk) if (rst_n && pe_c_mem_write[6]) begin
    if (pe_c_mem_q6 < 1) begin
      if (((($bitstoshortreal(pe_c_mem_din[6][31:0])) - ($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])) : ($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])))) || ((($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])) - ($bitstoshortreal(pe_c_mem_din[6][31:0]))) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])) : ($bitstoshortreal(pe_c_mem_exp6[pe_c_mem_q6][31:0])))))) begin
        errors = errors + 1;
        $display("MISMATCH pe_c_mem[%0d] step %0d: got %h want %h",
  ...
  always @(posedge clk) if (rst_n && pe_c_mem_write[7]) begin
    if (pe_c_mem_q7 < 1) begin
      if (((($bitstoshortreal(pe_c_mem_din[7][31:0])) - ($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])) : ($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])))) || ((($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])) - ($bitstoshortreal(pe_c_mem_din[7][31:0]))) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])) : ($bitstoshortreal(pe_c_mem_exp7[pe_c_mem_q7][31:0])))))) begin
        errors = errors + 1;
        $display("MISMATCH pe_c_mem[%0d] step %0d: got %h want %h",
  ...
  always @(posedge clk) if (rst_n && pe_c_mem_write[8]) begin
    if (pe_c_mem_q8 < 1) begin
      if (((($bitstoshortreal(pe_c_mem_din[8][31:0])) - ($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])) : ($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])))) || ((($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])) - ($bitstoshortreal(pe_c_mem_din[8][31:0]))) > 1e-06 + 1e-05 * ((($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])) < 0.0) ? -($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])) : ($bitstoshortreal(pe_c_mem_exp8[pe_c_mem_q8][31:0])))))) begin
        errors = errors + 1;
        $display("MISMATCH pe_c_mem[%0d] step %0d: got %h want %h",
