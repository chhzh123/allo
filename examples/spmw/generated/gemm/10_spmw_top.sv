...
module spmw_top (
  input  wire ap_clk,
  input  wire ap_rst_n,
  input  wire [31:0] pe_west_bind_dout [0:2],
  input  wire pe_west_bind_empty_n [0:2],
  output wire pe_west_bind_read [0:2],
  input  wire [31:0] pe_north_bind_dout [0:2],
  ...
  // family pe_east_west: 9 channel(s), 32-bit, depth 2
  wire [31:0] pe_east_west_din [0:8];
  wire [31:0] pe_east_west_dout [0:8];
  ...
  endgenerate
  // family pe_south_north: 9 channel(s), 32-bit, depth 2
  wire [31:0] pe_south_north_din [0:8];
  wire [31:0] pe_south_north_dout [0:8];
