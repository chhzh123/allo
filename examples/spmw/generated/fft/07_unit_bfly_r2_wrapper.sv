...
module bfly_r2 (
  ...
  bfly_r2_0 u (
      ...
      .ap_rst(~ap_rst_n),
      .v0_dout(lo_in_dout),
      .v0_empty_n(lo_in_empty_n),
      .v0_read(lo_in_read),
      .v1_din(lo_out_din),
      .v1_full_n(lo_out_full_n),
      .v1_write(lo_out_write),
      .v2_dout(up_in_dout),
      .v2_empty_n(up_in_empty_n),
      .v2_read(up_in_read),
      .v3_din(up_out_din),
      .v3_full_n(up_out_full_n),
      .v3_write(up_out_write),
      .v4_dout(_pid0_dout),
      .v4_empty_n(_pid0_empty_n),
      .v4_read(_pid0_read),
      .v5_dout(_pid1_dout),
      .v5_empty_n(_pid1_empty_n),
      .v5_read(_pid1_read));
endmodule
