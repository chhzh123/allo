...
module {
  ...
  func.func @top(%arg0: memref<4x4xi8>, %arg1: memref<4x4xi8>, %arg2: memref<4x4xi32>) attributes {dataflow, itypes = "sss", otypes = ""} {
    ...
    call @feed_up_load(%arg0, %c0, %71) : (memref<4x4xi8>, index, !allo.stream<memref<4xi8>, 16>) -> ()
    call @feed_3_up_load(%arg1, %c0, %70) : (memref<4x4xi8>, index, !allo.stream<memref<4xi8>, 16>) -> ()
    ...
    call @drain_down_drain(%arg2, %c0, %9) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    call @drain_down_drain(%arg2, %c1, %8) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    call @drain_down_drain(%arg2, %c2, %7) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    call @drain_down_drain(%arg2, %c3, %6) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    return
  }
}
