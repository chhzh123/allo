...
module {
  ...
  func.func @act_y_out_drain(%arg0: memref<6x4xi8, #map>, %arg1: index, %arg2: !allo.stream<i8, 6>) attributes {df.kernel, itypes = "s__", otypes = ""} {
    affine.for %arg3 = 0 to 6 {
      %0 = allo.stream_get(%arg2, []) : !allo.stream<i8, 6> -> i8
      affine.store %0, %arg0[%arg3, %arg1] {to = "local_Y"} : memref<6x4xi8, #map>
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @top(%arg0: memref<6x4xi8, #map>, %arg1: memref<4x4xi8, #map>, %arg2: memref<6x4xi8, #map>) attributes {dataflow, itypes = "sss", otypes = "", top} {
    ...
    call @mac_a_in_load(%arg0, %c0, %35) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    call @mac_a_in_load(%arg0, %c1, %34) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    call @mac_a_in_load(%arg0, %c2, %33) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    call @mac_a_in_load(%arg0, %c3, %32) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    call @mac_r8(%arg1, %c0, %c0, %35, %31, %30) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r2(%arg1, %c0, %c1, %31, %29, %28) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r2(%arg1, %c0, %c2, %29, %27, %26) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r6(%arg1, %c0, %c3, %27, %25) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r4(%arg1, %c1, %c0, %34, %24, %30, %23) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg1, %c1, %c1, %24, %22, %28, %21) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg1, %c1, %c2, %22, %20, %26, %19) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r3(%arg1, %c1, %c3, %20, %25, %18) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r4(%arg1, %c2, %c0, %33, %17, %23, %16) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg1, %c2, %c1, %17, %15, %21, %14) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg1, %c2, %c2, %15, %13, %19, %12) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r3(%arg1, %c2, %c3, %13, %18, %11) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r7(%arg1, %c3, %c0, %32, %10, %16, %9) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 6>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r1(%arg1, %c3, %c1, %10, %8, %14, %7) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r1(%arg1, %c3, %c2, %8, %6, %12, %5) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r5(%arg1, %c3, %c3, %6, %11, %4) : (memref<4x4xi8, #map>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    ...
    call @act_y_out_drain(%arg2, %c0, %3) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    call @act_y_out_drain(%arg2, %c1, %2) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    call @act_y_out_drain(%arg2, %c2, %1) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    call @act_y_out_drain(%arg2, %c3, %0) : (memref<6x4xi8, #map>, index, !allo.stream<i8, 6>) -> ()
    return
  }
}
