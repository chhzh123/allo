...
module spmw_top (
  ...
  output wire [7:0] act_y_out_bind_din [0:3],
  output wire act_y_out_bind_write [0:3],
  input  wire act_y_out_bind_full_n [0:3]
);
  ...
  endgenerate
  // family act_z_in_bind: 4 channel(s), 32-bit, depth 2
  wire [31:0] act_z_in_bind_din [0:3];
  wire [31:0] act_z_in_bind_dout [0:3];
  wire act_z_in_bind_full_n [0:3];
  wire act_z_in_bind_write [0:3];
  wire act_z_in_bind_empty_n [0:3];
  wire act_z_in_bind_read [0:3];
  genvar act_z_in_bind_i;
  generate
    for (act_z_in_bind_i = 0; act_z_in_bind_i < 4; act_z_in_bind_i = act_z_in_bind_i + 1) begin : g_act_z_in_bind
  ...
  mac_r1 u_mac_r1_3_2 (
      ...
      .p_out_din(act_z_in_bind_din[2]),
      .p_out_full_n(act_z_in_bind_full_n[2]),
      .p_out_write(act_z_in_bind_write[2]));
  ...
  mac_r5 u_mac_r5_3_3 (
      ...
      .p_out_din(act_z_in_bind_din[3]),
      .p_out_full_n(act_z_in_bind_full_n[3]),
      .p_out_write(act_z_in_bind_write[3]));
  ...
  act_r0 u_act_r0_2 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .y_out_din(act_y_out_bind_din[2]),
      .y_out_full_n(act_y_out_bind_full_n[2]),
      .y_out_write(act_y_out_bind_write[2]),
      .z_in_dout(act_z_in_bind_dout[2]),
      .z_in_empty_n(act_z_in_bind_empty_n[2]),
      .z_in_read(act_z_in_bind_read[2]));
  act_r0 u_act_r0_3 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .y_out_din(act_y_out_bind_din[3]),
      .y_out_full_n(act_y_out_bind_full_n[3]),
      .y_out_write(act_y_out_bind_write[3]),
      .z_in_dout(act_z_in_bind_dout[3]),
      .z_in_empty_n(act_z_in_bind_empty_n[3]),
      .z_in_read(act_z_in_bind_read[3]));
endmodule
