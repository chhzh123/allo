...
module tb;
  ...
  reg [7:0] mac_a_in_bind_src0 [0:7];
  ...
  initial begin
    ...
    mac_a_in_bind_src0[6] = 8'h01;
    mac_a_in_bind_src0[7] = 8'h02;
  end
  assign mac_a_in_bind_dout[0] = mac_a_in_bind_src0[mac_a_in_bind_p0 < 8 ? mac_a_in_bind_p0 : 7];
  assign mac_a_in_bind_empty_n[0] = (mac_a_in_bind_p0 < 8);
  always @(posedge clk) if (rst_n && mac_a_in_bind_read[0] && mac_a_in_bind_empty_n[0]) mac_a_in_bind_p0 <= mac_a_in_bind_p0 + 1;
  reg [7:0] mac_a_in_bind_src1 [0:7];
  ...
  initial begin
    ...
    mac_a_in_bind_src1[6] = 8'h02;
    mac_a_in_bind_src1[7] = 8'h02;
  end
  assign mac_a_in_bind_dout[1] = mac_a_in_bind_src1[mac_a_in_bind_p1 < 8 ? mac_a_in_bind_p1 : 7];
  assign mac_a_in_bind_empty_n[1] = (mac_a_in_bind_p1 < 8);
  always @(posedge clk) if (rst_n && mac_a_in_bind_read[1] && mac_a_in_bind_empty_n[1]) mac_a_in_bind_p1 <= mac_a_in_bind_p1 + 1;
  reg [7:0] mac_a_in_bind_src2 [0:7];
  ...
  initial begin
    ...
    mac_a_in_bind_src2[6] = 8'h01;
    mac_a_in_bind_src2[7] = 8'h02;
  end
  assign mac_a_in_bind_dout[2] = mac_a_in_bind_src2[mac_a_in_bind_p2 < 8 ? mac_a_in_bind_p2 : 7];
  assign mac_a_in_bind_empty_n[2] = (mac_a_in_bind_p2 < 8);
  always @(posedge clk) if (rst_n && mac_a_in_bind_read[2] && mac_a_in_bind_empty_n[2]) mac_a_in_bind_p2 <= mac_a_in_bind_p2 + 1;
  reg [7:0] mac_a_in_bind_src3 [0:7];
  ...
  initial begin
    ...
    mac_a_in_bind_src3[6] = 8'h00;
    mac_a_in_bind_src3[7] = 8'h00;
  end
  assign mac_a_in_bind_dout[3] = mac_a_in_bind_src3[mac_a_in_bind_p3 < 8 ? mac_a_in_bind_p3 : 7];
  assign mac_a_in_bind_empty_n[3] = (mac_a_in_bind_p3 < 8);
  ...
  reg [31:0] mac_op_in_bind_src0 [0:8];
  integer mac_op_in_bind_p0 = 0;
  initial begin
    mac_op_in_bind_src0[0] = 32'h00000008;
    mac_op_in_bind_src0[1] = 32'h01000000;
    mac_op_in_bind_src0[2] = 32'h03000000;
    mac_op_in_bind_src0[3] = 32'h01000000;
    mac_op_in_bind_src0[4] = 32'h03000000;
    mac_op_in_bind_src0[5] = 32'h01000000;
    mac_op_in_bind_src0[6] = 32'h03000000;
    mac_op_in_bind_src0[7] = 32'h01000000;
    mac_op_in_bind_src0[8] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[0] = mac_op_in_bind_src0[mac_op_in_bind_p0 < 9 ? mac_op_in_bind_p0 : 8];
  assign mac_op_in_bind_empty_n[0] = (mac_op_in_bind_p0 < 9);
  always @(posedge clk) if (rst_n && mac_op_in_bind_read[0] && mac_op_in_bind_empty_n[0]) mac_op_in_bind_p0 <= mac_op_in_bind_p0 + 1;
  reg [31:0] mac_op_in_bind_src1 [0:8];
  integer mac_op_in_bind_p1 = 0;
  initial begin
    mac_op_in_bind_src1[0] = 32'h00000008;
    mac_op_in_bind_src1[1] = 32'h01000000;
    mac_op_in_bind_src1[2] = 32'h03000000;
    mac_op_in_bind_src1[3] = 32'h01000000;
    mac_op_in_bind_src1[4] = 32'h03000000;
    mac_op_in_bind_src1[5] = 32'h01000000;
    mac_op_in_bind_src1[6] = 32'h03000000;
    mac_op_in_bind_src1[7] = 32'h01000000;
    mac_op_in_bind_src1[8] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[1] = mac_op_in_bind_src1[mac_op_in_bind_p1 < 9 ? mac_op_in_bind_p1 : 8];
  assign mac_op_in_bind_empty_n[1] = (mac_op_in_bind_p1 < 9);
  always @(posedge clk) if (rst_n && mac_op_in_bind_read[1] && mac_op_in_bind_empty_n[1]) mac_op_in_bind_p1 <= mac_op_in_bind_p1 + 1;
  reg [31:0] mac_op_in_bind_src2 [0:8];
  integer mac_op_in_bind_p2 = 0;
  initial begin
    mac_op_in_bind_src2[0] = 32'h00000008;
    mac_op_in_bind_src2[1] = 32'h01000000;
    mac_op_in_bind_src2[2] = 32'h03000000;
    mac_op_in_bind_src2[3] = 32'h01000000;
    mac_op_in_bind_src2[4] = 32'h03000000;
    mac_op_in_bind_src2[5] = 32'h01000000;
    mac_op_in_bind_src2[6] = 32'h03000000;
    mac_op_in_bind_src2[7] = 32'h01000000;
    mac_op_in_bind_src2[8] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[2] = mac_op_in_bind_src2[mac_op_in_bind_p2 < 9 ? mac_op_in_bind_p2 : 8];
  assign mac_op_in_bind_empty_n[2] = (mac_op_in_bind_p2 < 9);
  always @(posedge clk) if (rst_n && mac_op_in_bind_read[2] && mac_op_in_bind_empty_n[2]) mac_op_in_bind_p2 <= mac_op_in_bind_p2 + 1;
  reg [31:0] mac_op_in_bind_src3 [0:8];
  integer mac_op_in_bind_p3 = 0;
  initial begin
    mac_op_in_bind_src3[0] = 32'h00000008;
    mac_op_in_bind_src3[1] = 32'h01000000;
    mac_op_in_bind_src3[2] = 32'h03000000;
    mac_op_in_bind_src3[3] = 32'h01000000;
    mac_op_in_bind_src3[4] = 32'h03000000;
    mac_op_in_bind_src3[5] = 32'h01000000;
    mac_op_in_bind_src3[6] = 32'h03000000;
    mac_op_in_bind_src3[7] = 32'h01000000;
    mac_op_in_bind_src3[8] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[3] = mac_op_in_bind_src3[mac_op_in_bind_p3 < 9 ? mac_op_in_bind_p3 : 8];
  assign mac_op_in_bind_empty_n[3] = (mac_op_in_bind_p3 < 9);
  ...
  reg [31:0] mac_w_mem_src0 [0:0];
  integer mac_w_mem_p0 = 0;
  initial begin
    mac_w_mem_src0[0] = 32'h01000200;
  end
  ...
  reg [31:0] mac_w_mem_src1 [0:0];
  integer mac_w_mem_p1 = 0;
  initial begin
    mac_w_mem_src1[0] = 32'h01010000;
  end
  ...
  reg [31:0] mac_w_mem_src2 [0:0];
  integer mac_w_mem_p2 = 0;
  initial begin
    mac_w_mem_src2[0] = 32'h00000001;
  end
  ...
  reg [31:0] mac_w_mem_src3 [0:0];
  integer mac_w_mem_p3 = 0;
  initial begin
    mac_w_mem_src3[0] = 32'h01010200;
  end
  ...
  reg [31:0] mac_w_mem_src4 [0:0];
  integer mac_w_mem_p4 = 0;
  initial begin
    mac_w_mem_src4[0] = 32'h01020100;
  end
  ...
  reg [31:0] mac_w_mem_src5 [0:0];
  integer mac_w_mem_p5 = 0;
  initial begin
    mac_w_mem_src5[0] = 32'h02020201;
  end
  ...
  reg [31:0] mac_w_mem_src6 [0:0];
  integer mac_w_mem_p6 = 0;
  initial begin
    mac_w_mem_src6[0] = 32'h01020201;
  end
  ...
  reg [31:0] mac_w_mem_src7 [0:0];
  integer mac_w_mem_p7 = 0;
  initial begin
    mac_w_mem_src7[0] = 32'h01020202;
  end
  ...
  reg [31:0] mac_w_mem_src8 [0:0];
  integer mac_w_mem_p8 = 0;
  initial begin
    mac_w_mem_src8[0] = 32'h02010002;
  end
  ...
  reg [31:0] mac_w_mem_src9 [0:0];
  integer mac_w_mem_p9 = 0;
  initial begin
    mac_w_mem_src9[0] = 32'h00010102;
  end
  ...
  reg [31:0] mac_w_mem_src10 [0:0];
  integer mac_w_mem_p10 = 0;
  initial begin
    mac_w_mem_src10[0] = 32'h02020101;
  end
  ...
  reg [31:0] mac_w_mem_src11 [0:0];
  integer mac_w_mem_p11 = 0;
  initial begin
    mac_w_mem_src11[0] = 32'h01010200;
  end
  ...
  reg [31:0] mac_w_mem_src12 [0:0];
  integer mac_w_mem_p12 = 0;
  initial begin
    mac_w_mem_src12[0] = 32'h00000102;
  end
  ...
  reg [31:0] mac_w_mem_src13 [0:0];
  integer mac_w_mem_p13 = 0;
  initial begin
    mac_w_mem_src13[0] = 32'h01010102;
  end
  ...
  reg [31:0] mac_w_mem_src14 [0:0];
  integer mac_w_mem_p14 = 0;
  initial begin
    mac_w_mem_src14[0] = 32'h02000102;
  end
  ...
  reg [31:0] mac_w_mem_src15 [0:0];
  integer mac_w_mem_p15 = 0;
  initial begin
    mac_w_mem_src15[0] = 32'h01020000;
  end
  ...
  initial begin
    vpu_op_in_bind_src0[0] = 32'h00040005;
    vpu_op_in_bind_src0[1] = 32'h03000000;
    vpu_op_in_bind_src0[2] = 32'h09000000;
    vpu_op_in_bind_src0[3] = 32'h09000000;
    vpu_op_in_bind_src0[4] = 32'h07000004;
    vpu_op_in_bind_src0[5] = 32'h08000000;
    vpu_op_in_bind_src0[6] = 32'h00000000;
    vpu_op_in_bind_src0[7] = 32'h00000000;
    vpu_op_in_bind_src0[8] = 32'h00000000;
    vpu_op_in_bind_src0[9] = 32'h00000000;
    vpu_op_in_bind_src0[10] = 32'h00000000;
    vpu_op_in_bind_src0[11] = 32'h00000000;
    vpu_op_in_bind_src0[12] = 32'h00000000;
  ...
  wire vpu_b_mem_read [0:3];
  reg [63:0] vpu_b_mem_src0 [0:0];
  integer vpu_b_mem_p0 = 0;
  initial begin
    vpu_b_mem_src0[0] = 64'h0000000000000000;
  end
  assign vpu_b_mem_dout[0] = vpu_b_mem_src0[vpu_b_mem_p0 < 1 ? vpu_b_mem_p0 : 0];
  assign vpu_b_mem_empty_n[0] = (vpu_b_mem_p0 < 1);
  always @(posedge clk) if (rst_n && vpu_b_mem_read[0] && vpu_b_mem_empty_n[0]) vpu_b_mem_p0 <= vpu_b_mem_p0 + 1;
  reg [63:0] vpu_b_mem_src1 [0:0];
  integer vpu_b_mem_p1 = 0;
  initial begin
    vpu_b_mem_src1[0] = 64'h0000000200000001;
  end
  assign vpu_b_mem_dout[1] = vpu_b_mem_src1[vpu_b_mem_p1 < 1 ? vpu_b_mem_p1 : 0];
  assign vpu_b_mem_empty_n[1] = (vpu_b_mem_p1 < 1);
  always @(posedge clk) if (rst_n && vpu_b_mem_read[1] && vpu_b_mem_empty_n[1]) vpu_b_mem_p1 <= vpu_b_mem_p1 + 1;
  reg [63:0] vpu_b_mem_src2 [0:0];
  integer vpu_b_mem_p2 = 0;
  initial begin
    vpu_b_mem_src2[0] = 64'h0000000200000001;
  end
  assign vpu_b_mem_dout[2] = vpu_b_mem_src2[vpu_b_mem_p2 < 1 ? vpu_b_mem_p2 : 0];
  assign vpu_b_mem_empty_n[2] = (vpu_b_mem_p2 < 1);
  always @(posedge clk) if (rst_n && vpu_b_mem_read[2] && vpu_b_mem_empty_n[2]) vpu_b_mem_p2 <= vpu_b_mem_p2 + 1;
  reg [63:0] vpu_b_mem_src3 [0:0];
  integer vpu_b_mem_p3 = 0;
  initial begin
    vpu_b_mem_src3[0] = 64'h0000000000000000;
  end
  ...
  reg [31:0] vpu_y_out_bind_exp0 [0:3];
  integer vpu_y_out_bind_q0 = 0;
  initial begin
    vpu_y_out_bind_exp0[0] = 32'h00000000;
    vpu_y_out_bind_exp0[1] = 32'h00000000;
    vpu_y_out_bind_exp0[2] = 32'h00000000;
    vpu_y_out_bind_exp0[3] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[0] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[0]) begin
    if (vpu_y_out_bind_q0 < 4) begin
      if (vpu_y_out_bind_din[0] !== vpu_y_out_bind_exp0[vpu_y_out_bind_q0]) begin
        errors = errors + 1;
        $display("MISMATCH vpu_y_out_bind[%0d] step %0d: got %h want %h",
                 0, vpu_y_out_bind_q0, vpu_y_out_bind_din[0], vpu_y_out_bind_exp0[vpu_y_out_bind_q0]);
      end
      vpu_y_out_bind_q0 <= vpu_y_out_bind_q0 + 1;
      produced = produced + 1;
    end else begin
      errors = errors + 1;
      $display("EXTRA TOKEN on vpu_y_out_bind[%0d]", 0);
    end
  end
  reg [31:0] vpu_y_out_bind_exp1 [0:3];
  integer vpu_y_out_bind_q1 = 0;
  initial begin
    vpu_y_out_bind_exp1[0] = 32'h00000000;
    vpu_y_out_bind_exp1[1] = 32'h00000000;
    vpu_y_out_bind_exp1[2] = 32'h00000000;
    vpu_y_out_bind_exp1[3] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[1] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[1]) begin
    if (vpu_y_out_bind_q1 < 4) begin
      if (vpu_y_out_bind_din[1] !== vpu_y_out_bind_exp1[vpu_y_out_bind_q1]) begin
        errors = errors + 1;
        $display("MISMATCH vpu_y_out_bind[%0d] step %0d: got %h want %h",
                 1, vpu_y_out_bind_q1, vpu_y_out_bind_din[1], vpu_y_out_bind_exp1[vpu_y_out_bind_q1]);
      end
      vpu_y_out_bind_q1 <= vpu_y_out_bind_q1 + 1;
      produced = produced + 1;
    end else begin
      errors = errors + 1;
      $display("EXTRA TOKEN on vpu_y_out_bind[%0d]", 1);
    end
  end
  reg [31:0] vpu_y_out_bind_exp2 [0:3];
  integer vpu_y_out_bind_q2 = 0;
  initial begin
    vpu_y_out_bind_exp2[0] = 32'h00000000;
    vpu_y_out_bind_exp2[1] = 32'h00000000;
    vpu_y_out_bind_exp2[2] = 32'h00000000;
    vpu_y_out_bind_exp2[3] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[2] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[2]) begin
    if (vpu_y_out_bind_q2 < 4) begin
      if (vpu_y_out_bind_din[2] !== vpu_y_out_bind_exp2[vpu_y_out_bind_q2]) begin
        errors = errors + 1;
        $display("MISMATCH vpu_y_out_bind[%0d] step %0d: got %h want %h",
                 2, vpu_y_out_bind_q2, vpu_y_out_bind_din[2], vpu_y_out_bind_exp2[vpu_y_out_bind_q2]);
      end
      vpu_y_out_bind_q2 <= vpu_y_out_bind_q2 + 1;
      produced = produced + 1;
    end else begin
      errors = errors + 1;
      $display("EXTRA TOKEN on vpu_y_out_bind[%0d]", 2);
    end
  end
  reg [31:0] vpu_y_out_bind_exp3 [0:3];
  integer vpu_y_out_bind_q3 = 0;
  initial begin
    vpu_y_out_bind_exp3[0] = 32'h00000000;
    vpu_y_out_bind_exp3[1] = 32'h00000000;
    vpu_y_out_bind_exp3[2] = 32'h00000000;
    vpu_y_out_bind_exp3[3] = 32'h00000000;
  end
  assign vpu_y_out_bind_full_n[3] = 1'b1;
  always @(posedge clk) if (rst_n && vpu_y_out_bind_write[3]) begin
    if (vpu_y_out_bind_q3 < 4) begin
      if (vpu_y_out_bind_din[3] !== vpu_y_out_bind_exp3[vpu_y_out_bind_q3]) begin
        errors = errors + 1;
        $display("MISMATCH vpu_y_out_bind[%0d] step %0d: got %h want %h",
                 3, vpu_y_out_bind_q3, vpu_y_out_bind_din[3], vpu_y_out_bind_exp3[vpu_y_out_bind_q3]);
      end
      vpu_y_out_bind_q3 <= vpu_y_out_bind_q3 + 1;
      produced = produced + 1;
    end else begin
      errors = errors + 1;
      $display("EXTRA TOKEN on vpu_y_out_bind[%0d]", 3);
    end
  end
