...
module tb;
  ...
  reg [31:0] mac_op_in_bind_src0 [0:7];
  integer mac_op_in_bind_p0 = 0;
  initial begin
    mac_op_in_bind_src0[0] = 32'h01000000;
    mac_op_in_bind_src0[1] = 32'h03000000;
    mac_op_in_bind_src0[2] = 32'h01000000;
    mac_op_in_bind_src0[3] = 32'h03000000;
    mac_op_in_bind_src0[4] = 32'h01000000;
    mac_op_in_bind_src0[5] = 32'h03000000;
    mac_op_in_bind_src0[6] = 32'h01000000;
    mac_op_in_bind_src0[7] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[0] = mac_op_in_bind_src0[mac_op_in_bind_p0 < 8 ? mac_op_in_bind_p0 : 7];
  assign mac_op_in_bind_empty_n[0] = (mac_op_in_bind_p0 < 8);
  always @(posedge clk) if (rst_n && mac_op_in_bind_read[0] && mac_op_in_bind_empty_n[0]) mac_op_in_bind_p0 <= mac_op_in_bind_p0 + 1;
  reg [31:0] mac_op_in_bind_src1 [0:7];
  integer mac_op_in_bind_p1 = 0;
  initial begin
    mac_op_in_bind_src1[0] = 32'h01000000;
    mac_op_in_bind_src1[1] = 32'h03000000;
    mac_op_in_bind_src1[2] = 32'h01000000;
    mac_op_in_bind_src1[3] = 32'h03000000;
    mac_op_in_bind_src1[4] = 32'h01000000;
    mac_op_in_bind_src1[5] = 32'h03000000;
    mac_op_in_bind_src1[6] = 32'h01000000;
    mac_op_in_bind_src1[7] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[1] = mac_op_in_bind_src1[mac_op_in_bind_p1 < 8 ? mac_op_in_bind_p1 : 7];
  assign mac_op_in_bind_empty_n[1] = (mac_op_in_bind_p1 < 8);
  always @(posedge clk) if (rst_n && mac_op_in_bind_read[1] && mac_op_in_bind_empty_n[1]) mac_op_in_bind_p1 <= mac_op_in_bind_p1 + 1;
  reg [31:0] mac_op_in_bind_src2 [0:7];
  integer mac_op_in_bind_p2 = 0;
  initial begin
    mac_op_in_bind_src2[0] = 32'h01000000;
    mac_op_in_bind_src2[1] = 32'h03000000;
    mac_op_in_bind_src2[2] = 32'h01000000;
    mac_op_in_bind_src2[3] = 32'h03000000;
    mac_op_in_bind_src2[4] = 32'h01000000;
    mac_op_in_bind_src2[5] = 32'h03000000;
    mac_op_in_bind_src2[6] = 32'h01000000;
    mac_op_in_bind_src2[7] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[2] = mac_op_in_bind_src2[mac_op_in_bind_p2 < 8 ? mac_op_in_bind_p2 : 7];
  assign mac_op_in_bind_empty_n[2] = (mac_op_in_bind_p2 < 8);
  always @(posedge clk) if (rst_n && mac_op_in_bind_read[2] && mac_op_in_bind_empty_n[2]) mac_op_in_bind_p2 <= mac_op_in_bind_p2 + 1;
  reg [31:0] mac_op_in_bind_src3 [0:7];
  integer mac_op_in_bind_p3 = 0;
  initial begin
    mac_op_in_bind_src3[0] = 32'h01000000;
    mac_op_in_bind_src3[1] = 32'h03000000;
    mac_op_in_bind_src3[2] = 32'h01000000;
    mac_op_in_bind_src3[3] = 32'h03000000;
    mac_op_in_bind_src3[4] = 32'h01000000;
    mac_op_in_bind_src3[5] = 32'h03000000;
    mac_op_in_bind_src3[6] = 32'h01000000;
    mac_op_in_bind_src3[7] = 32'h03000000;
  end
  assign mac_op_in_bind_dout[3] = mac_op_in_bind_src3[mac_op_in_bind_p3 < 8 ? mac_op_in_bind_p3 : 7];
  assign mac_op_in_bind_empty_n[3] = (mac_op_in_bind_p3 < 8);
  ...
  initial begin
    ...
    vpu_op_in_bind_src0[3] = 32'h07000004;
    vpu_op_in_bind_src0[4] = 32'h08000000;
