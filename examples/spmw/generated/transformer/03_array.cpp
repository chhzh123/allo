...
void mac_a_in_load_0(
  ...
  l_S__t_0__t: for (int _t = 0; _t < 8; _t++) {	// L6
...
void mac_a_in_load_1(
  ...
  l_S__t_0__t1: for (int _t1 = 0; _t1 < 8; _t1++) {	// L13
  #pragma HLS pipeline II=1
...
void mac_a_in_load_2(
  ...
  l_S__t_0__t2: for (int _t2 = 0; _t2 < 8; _t2++) {	// L20
  #pragma HLS pipeline II=1
...
void mac_a_in_load_3(
  ...
  l_S__t_0__t3: for (int _t3 = 0; _t3 < 8; _t3++) {	// L27
  #pragma HLS pipeline II=1
...
void mac_op_in_load_0(
  ...
  l_S__t_0__t4: for (int _t4 = 0; _t4 < 8; _t4++) {	// L34
  #pragma HLS pipeline II=1
...
void mac_op_in_load_1(
  ...
  l_S__t_0__t5: for (int _t5 = 0; _t5 < 8; _t5++) {	// L41
  #pragma HLS pipeline II=1
...
void mac_op_in_load_2(
  ...
  l_S__t_0__t6: for (int _t6 = 0; _t6 < 8; _t6++) {	// L48
  #pragma HLS pipeline II=1
...
void mac_op_in_load_3(
  ...
  l_S__t_0__t7: for (int _t7 = 0; _t7 < 8; _t7++) {	// L55
  #pragma HLS pipeline II=1
...
void mac_0_0(
  ...
  l_S_step_0_step: for (int step = 0; step < 8; step++) {	// L76
  #pragma HLS pipeline II=1
...
void mac_0_1(
  ...
  l_S_step_0_step1: for (int step1 = 0; step1 < 8; step1++) {	// L145
  #pragma HLS pipeline II=1
...
void mac_0_2(
  ...
  l_S_step_0_step2: for (int step2 = 0; step2 < 8; step2++) {	// L214
  #pragma HLS pipeline II=1
...
void mac_0_3(
  ...
  l_S_step_0_step3: for (int step3 = 0; step3 < 8; step3++) {	// L283
  #pragma HLS pipeline II=1
...
void mac_1_0(
  ...
  l_S_step_0_step4: for (int step4 = 0; step4 < 8; step4++) {	// L347
  #pragma HLS pipeline II=1
...
void mac_1_1(
  ...
  l_S_step_0_step5: for (int step5 = 0; step5 < 8; step5++) {	// L415
  #pragma HLS pipeline II=1
...
void mac_1_2(
  ...
  l_S_step_0_step6: for (int step6 = 0; step6 < 8; step6++) {	// L484
  #pragma HLS pipeline II=1
...
void mac_1_3(
  ...
  l_S_step_0_step7: for (int step7 = 0; step7 < 8; step7++) {	// L553
  #pragma HLS pipeline II=1
...
void mac_2_0(
  ...
  l_S_step_0_step8: for (int step8 = 0; step8 < 8; step8++) {	// L618
  #pragma HLS pipeline II=1
...
void mac_2_1(
  ...
  l_S_step_0_step9: for (int step9 = 0; step9 < 8; step9++) {	// L687
  #pragma HLS pipeline II=1
...
void mac_2_2(
  ...
  l_S_step_0_step10: for (int step10 = 0; step10 < 8; step10++) {	// L755
  #pragma HLS pipeline II=1
...
void mac_2_3(
  ...
  l_S_step_0_step11: for (int step11 = 0; step11 < 8; step11++) {	// L824
  #pragma HLS pipeline II=1
...
void mac_3_0(
  ...
  l_S_step_0_step12: for (int step12 = 0; step12 < 8; step12++) {	// L889
  #pragma HLS pipeline II=1
...
void mac_3_1(
  ...
  l_S_step_0_step13: for (int step13 = 0; step13 < 8; step13++) {	// L958
  #pragma HLS pipeline II=1
...
void mac_3_2(
  ...
  l_S_step_0_step14: for (int step14 = 0; step14 < 8; step14++) {	// L1027
  #pragma HLS pipeline II=1
...
void mac_3_3(
  ...
  l_S_step_0_step15: for (int step15 = 0; step15 < 8; step15++) {	// L1095
  #pragma HLS pipeline II=1
