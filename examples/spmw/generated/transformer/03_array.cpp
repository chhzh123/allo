...
void mac_op_in_load(
  ...
  l_S__t_0__t1: for (int _t1 = 0; _t1 < 9; _t1++) {	// L13
  #pragma HLS pipeline II=1
...
void top(
  ...
  #pragma HLS stream variable=v1105 depth=9	// L1789
  hls::stream< int32_t > v1106;
  #pragma HLS stream variable=v1106 depth=9	// L1790
  hls::stream< int32_t > v1107;
  #pragma HLS stream variable=v1107 depth=9	// L1791
  hls::stream< int32_t > v1108;
  #pragma HLS stream variable=v1108 depth=9	// L1792
  hls::stream< int8_t > v1109;
  #pragma HLS stream variable=v1109 depth=8	// L1793
  hls::stream< int8_t > v1110;
  #pragma HLS stream variable=v1110 depth=8	// L1795
  hls::stream< int8_t > v1111;
  #pragma HLS stream variable=v1111 depth=8	// L1797
  hls::stream< int8_t > v1112;
  #pragma HLS stream variable=v1112 depth=8	// L1799
