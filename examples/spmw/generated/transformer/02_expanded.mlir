module {
  func.func @mac_a_in_load(%arg0: memref<8x4xi8>, %arg1: index, %arg2: !allo.stream<i8, 8>) attributes {df.kernel, itypes = "s__", otypes = ""} {
    affine.for %arg3 = 0 to 8 {
      %0 = affine.load %arg0[%arg3, %arg1] {from = "local_A"} : memref<8x4xi8>
      allo.stream_put(%arg2, [], %0) : !allo.stream<i8, 8> contains i8
    } {loop_name = "_t", op_name = "S__t_0"}
    return
  }
  func.func @mac_op_in_load(%arg0: memref<9x4xi32>, %arg1: index, %arg2: !allo.stream<i32, 9>) attributes {df.kernel, itypes = "s__", otypes = ""} {
    affine.for %arg3 = 0 to 9 {
      %0 = affine.load %arg0[%arg3, %arg1] {from = "local_MProg"} : memref<9x4xi32>
      allo.stream_put(%arg2, [], %0) : !allo.stream<i32, 9> contains i32
    } {loop_name = "_t", op_name = "S__t_0"}
    return
  }
  ...
  func.func @mac_r4(%arg0: memref<4x4x4xi8>, %arg1: index, %arg2: index, %arg3: !allo.stream<i8, 8>, %arg4: !allo.stream<i8, 2>, %arg5: !allo.stream<i32, 9>, %arg6: !allo.stream<i32, 2>, %arg7: !allo.stream<i32, 2>, %arg8: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s________", otypes = ""} {
    %0 = allo.stream_get(%arg5, []) : !allo.stream<i32, 9> -> i32
    %alloc = memref.alloc() {name = "count"} : memref<i32>
    affine.store %0, %alloc[] {to = "count"} : memref<i32>
    %1 = affine.load %alloc[] {from = "count"} : memref<i32>
    allo.stream_put(%arg6, [], %1) : !allo.stream<i32, 2> contains i32
    ...
    %5 = arith.index_cast %c1_i32_1 : i32 to index
    scf.for %arg9 = %3 to %4 step %5 {
      %6 = allo.stream_get(%arg5, []) : !allo.stream<i32, 9> -> i32
      %alloc_2 = memref.alloc() {name = "word"} : memref<i32>
      affine.store %6, %alloc_2[] {to = "word"} : memref<i32>
      %7 = affine.load %alloc_2[] {from = "word"} : memref<i32>
      allo.stream_put(%arg6, [], %7) : !allo.stream<i32, 2> contains i32
      ...
      %alloc_9 = memref.alloc() {name = "tile"} : memref<i32>
      affine.store %13, %alloc_9[] {to = "tile"} : memref<i32>
      %14 = allo.stream_get(%arg3, []) : !allo.stream<i8, 8> -> i8
      %alloc_10 = memref.alloc() {name = "a"} : memref<i8>
      affine.store %14, %alloc_10[] {to = "a"} : memref<i8>
      %15 = allo.stream_get(%arg7, []) : !allo.stream<i32, 2> -> i32
      %alloc_11 = memref.alloc() {name = "p"} : memref<i32>
  ...
  func.func @mac_r7(%arg0: memref<4x4x4xi8>, %arg1: index, %arg2: index, %arg3: !allo.stream<i8, 8>, %arg4: !allo.stream<i8, 2>, %arg5: !allo.stream<i32, 9>, %arg6: !allo.stream<i32, 2>, %arg7: !allo.stream<i32, 2>, %arg8: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s________", otypes = ""} {
    %0 = allo.stream_get(%arg5, []) : !allo.stream<i32, 9> -> i32
    %alloc = memref.alloc() {name = "count"} : memref<i32>
    affine.store %0, %alloc[] {to = "count"} : memref<i32>
    %1 = affine.load %alloc[] {from = "count"} : memref<i32>
  ...
  func.func @mac_r8(%arg0: memref<4x4x4xi8>, %arg1: index, %arg2: index, %arg3: !allo.stream<i8, 8>, %arg4: !allo.stream<i8, 2>, %arg5: !allo.stream<i32, 9>, %arg6: !allo.stream<i32, 2>, %arg7: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s_______", otypes = ""} {
    %0 = allo.stream_get(%arg5, []) : !allo.stream<i32, 9> -> i32
    %alloc = memref.alloc() {name = "count"} : memref<i32>
    affine.store %0, %alloc[] {to = "count"} : memref<i32>
    %1 = affine.load %alloc[] {from = "count"} : memref<i32>
  ...
  func.func @top(%arg0: memref<8x4xi8>, %arg1: memref<9x4xi32>, %arg2: memref<17xi32>, %arg3: memref<4x4x4xi8>, %arg4: memref<4x2xi32>, %arg5: memref<4x4xi32>) attributes {dataflow, itypes = "ssssss", otypes = ""} {
    ...
    %48 = allo.stream_construct() {name = "mac_op_in_bind_3"} : !allo.stream<i32, 9>
    %49 = allo.stream_construct() {name = "mac_op_in_bind_2"} : !allo.stream<i32, 9>
    %50 = allo.stream_construct() {name = "mac_op_in_bind_1"} : !allo.stream<i32, 9>
    %51 = allo.stream_construct() {name = "mac_op_in_bind_0"} : !allo.stream<i32, 9>
    %52 = allo.stream_construct() {name = "mac_a_in_bind_3"} : !allo.stream<i8, 8>
    %c3 = arith.constant 3 : index
    %53 = allo.stream_construct() {name = "mac_a_in_bind_2"} : !allo.stream<i8, 8>
    %c2 = arith.constant 2 : index
    %54 = allo.stream_construct() {name = "mac_a_in_bind_1"} : !allo.stream<i8, 8>
    %c1 = arith.constant 1 : index
    %55 = allo.stream_construct() {name = "mac_a_in_bind_0"} : !allo.stream<i8, 8>
    %c0 = arith.constant 0 : index
    call @mac_a_in_load(%arg0, %c0, %55) : (memref<8x4xi8>, index, !allo.stream<i8, 8>) -> ()
    call @mac_a_in_load(%arg0, %c1, %54) : (memref<8x4xi8>, index, !allo.stream<i8, 8>) -> ()
    call @mac_a_in_load(%arg0, %c2, %53) : (memref<8x4xi8>, index, !allo.stream<i8, 8>) -> ()
    call @mac_a_in_load(%arg0, %c3, %52) : (memref<8x4xi8>, index, !allo.stream<i8, 8>) -> ()
    call @mac_op_in_load(%arg1, %c0, %51) : (memref<9x4xi32>, index, !allo.stream<i32, 9>) -> ()
    call @mac_op_in_load(%arg1, %c1, %50) : (memref<9x4xi32>, index, !allo.stream<i32, 9>) -> ()
    call @mac_op_in_load(%arg1, %c2, %49) : (memref<9x4xi32>, index, !allo.stream<i32, 9>) -> ()
    call @mac_op_in_load(%arg1, %c3, %48) : (memref<9x4xi32>, index, !allo.stream<i32, 9>) -> ()
    call @vpu_op_in_load(%arg2, %c0, %47) : (memref<17xi32>, index, !allo.stream<i32, 17>) -> ()
    call @mac_r8(%arg3, %c0, %c0, %55, %46, %51, %45, %44) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r2(%arg3, %c0, %c1, %46, %43, %45, %42, %41) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r2(%arg3, %c0, %c2, %43, %40, %42, %39, %38) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r6(%arg3, %c0, %c3, %40, %39, %37) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r4(%arg3, %c1, %c0, %54, %36, %50, %35, %44, %34) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg3, %c1, %c1, %36, %33, %35, %32, %41, %31) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg3, %c1, %c2, %33, %30, %32, %29, %38, %28) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r3(%arg3, %c1, %c3, %30, %29, %37, %27) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r4(%arg3, %c2, %c0, %53, %26, %49, %25, %34, %24) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg3, %c2, %c1, %26, %23, %25, %22, %31, %21) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r0(%arg3, %c2, %c2, %23, %20, %22, %19, %28, %18) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r3(%arg3, %c2, %c3, %20, %19, %27, %17) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r7(%arg3, %c3, %c0, %52, %16, %48, %15, %24, %14) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r1(%arg3, %c3, %c1, %16, %13, %15, %12, %21, %11) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r1(%arg3, %c3, %c2, %13, %10, %12, %9, %18, %8) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @mac_r5(%arg3, %c3, %c3, %10, %9, %17, %7) : (memref<4x4x4xi8>, index, index, !allo.stream<i8, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    call @vpu_r2(%arg4, %c0, %47, %6, %5, %14) : (memref<4x2xi32>, index, !allo.stream<i32, 17>, !allo.stream<i32, 2>, !allo.stream<i32, 4>, !allo.stream<i32, 2>) -> ()
    call @vpu_r0(%arg4, %c1, %6, %4, %3, %11) : (memref<4x2xi32>, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 4>, !allo.stream<i32, 2>) -> ()
    call @vpu_r0(%arg4, %c2, %4, %2, %1, %8) : (memref<4x2xi32>, index, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 4>, !allo.stream<i32, 2>) -> ()
    call @vpu_r1(%arg4, %c3, %2, %0, %7) : (memref<4x2xi32>, index, !allo.stream<i32, 2>, !allo.stream<i32, 4>, !allo.stream<i32, 2>) -> ()
    call @vpu_y_out_drain(%arg5, %c0, %5) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    call @vpu_y_out_drain(%arg5, %c1, %3) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    call @vpu_y_out_drain(%arg5, %c2, %1) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    call @vpu_y_out_drain(%arg5, %c3, %0) : (memref<4x4xi32>, index, !allo.stream<i32, 4>) -> ()
    return
  }
}
