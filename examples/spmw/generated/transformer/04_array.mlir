...
module {
  func.func @mac_a_in_load(%arg0: memref<8x4xi8, #map>, %arg1: index, %arg2: !allo.stream<i8, 8>) attributes {df.kernel, itypes = "s__", otypes = ""} {
    affine.for %arg3 = 0 to 8 {
      %0 = affine.load %arg0[%arg3, %arg1] {from = "local_A"} : memref<8x4xi8, #map>
      allo.stream_put(%arg2, [], %0) : !allo.stream<i8, 8> contains i8
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_op_in_load(%arg0: memref<9x4xi32, #map>, %arg1: index, %arg2: !allo.stream<i32, 9>) attributes {df.kernel, itypes = "s__", otypes = ""} {
    affine.for %arg3 = 0 to 9 {
      %0 = affine.load %arg0[%arg3, %arg1] {from = "local_MProg"} : memref<9x4xi32, #map>
  ...
  func.func @mac_r4(%arg0: memref<4x4x4xi8, #map2>, %arg1: index, %arg2: index, %arg3: !allo.stream<i8, 8>, %arg4: !allo.stream<i8, 2>, %arg5: !allo.stream<i32, 9>, %arg6: !allo.stream<i32, 2>, %arg7: !allo.stream<i32, 2>, %arg8: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s________", otypes = ""} {
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    %c2_i32 = arith.constant 2 : i32
    %c16_i32 = arith.constant 16 : i32
    ...
    %c24_i32 = arith.constant 24 : i32
    %c1_i32 = arith.constant {name = "%c1_i32"} 1 : i32
    %0 = allo.stream_get(%arg5, []) {name = "%0"} : !allo.stream<i32, 9> -> i32
    %alloc = memref.alloc() {name = "count"} : memref<i32>
    affine.store %0, %alloc[] {to = "count"} : memref<i32>
    %1 = affine.load %alloc[] {from = "count"} : memref<i32>
    allo.stream_put(%arg6, [], %1) : !allo.stream<i32, 2> contains i32
    ...
    %3 = arith.index_cast %2 {name = "%4"} : i32 to index
    scf.for %arg9 = %c0 to %3 step %c1 {
      %4 = allo.stream_get(%arg5, []) : !allo.stream<i32, 9> -> i32
      %alloc_0 = memref.alloc() {name = "word"} : memref<i32>
      affine.store %4, %alloc_0[] {to = "word"} : memref<i32>
      %5 = affine.load %alloc_0[] {from = "word"} : memref<i32>
      allo.stream_put(%arg6, [], %5) : !allo.stream<i32, 2> contains i32
      ...
      %alloc_2 = memref.alloc() {name = "tile"} : memref<i32>
      affine.store %11, %alloc_2[] {to = "tile"} : memref<i32>
      %12 = allo.stream_get(%arg3, []) : !allo.stream<i8, 8> -> i8
      %alloc_3 = memref.alloc() {name = "a"} : memref<i8>
      affine.store %12, %alloc_3[] {to = "a"} : memref<i8>
      %13 = allo.stream_get(%arg7, []) : !allo.stream<i32, 2> -> i32
      %alloc_4 = memref.alloc() {name = "p"} : memref<i32>
  ...
  func.func @mac_r7(%arg0: memref<4x4x4xi8, #map2>, %arg1: index, %arg2: index, %arg3: !allo.stream<i8, 8>, %arg4: !allo.stream<i8, 2>, %arg5: !allo.stream<i32, 9>, %arg6: !allo.stream<i32, 2>, %arg7: !allo.stream<i32, 2>, %arg8: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s________", otypes = ""} {
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    %c2_i32 = arith.constant 2 : i32
    %c16_i32 = arith.constant 16 : i32
  ...
  func.func @mac_r8(%arg0: memref<4x4x4xi8, #map2>, %arg1: index, %arg2: index, %arg3: !allo.stream<i8, 8>, %arg4: !allo.stream<i8, 2>, %arg5: !allo.stream<i32, 9>, %arg6: !allo.stream<i32, 2>, %arg7: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s_______", otypes = ""} {
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    %c2_i32 = arith.constant 2 : i32
    %c16_i32 = arith.constant 16 : i32
  ...
  func.func @top(%arg0: memref<8x4xi8, #map>, %arg1: memref<9x4xi32, #map>, %arg2: memref<17xi32, #map1>, %arg3: memref<4x4x4xi8, #map2>, %arg4: memref<4x2xi32, #map>, %arg5: memref<4x4xi32, #map>) attributes {dataflow, itypes = "ssssss", otypes = "", top} {
    ...
    call @mac_a_in_load(%arg0, %c0, %55) : (memref<8x4xi8, #map>, index, !allo.stream<i8, 8>) -> ()
    call @mac_a_in_load(%arg0, %c1, %54) : (memref<8x4xi8, #map>, index, !allo.stream<i8, 8>) -> ()
    call @mac_a_in_load(%arg0, %c2, %53) : (memref<8x4xi8, #map>, index, !allo.stream<i8, 8>) -> ()
    call @mac_a_in_load(%arg0, %c3, %52) : (memref<8x4xi8, #map>, index, !allo.stream<i8, 8>) -> ()
    call @mac_op_in_load(%arg1, %c0, %51) : (memref<9x4xi32, #map>, index, !allo.stream<i32, 9>) -> ()
    call @mac_op_in_load(%arg1, %c1, %50) : (memref<9x4xi32, #map>, index, !allo.stream<i32, 9>) -> ()
    call @mac_op_in_load(%arg1, %c2, %49) : (memref<9x4xi32, #map>, index, !allo.stream<i32, 9>) -> ()
    call @mac_op_in_load(%arg1, %c3, %48) : (memref<9x4xi32, #map>, index, !allo.stream<i32, 9>) -> ()
    call @vpu_op_in_load(%arg2, %c0, %47) : (memref<17xi32, #map1>, index, !allo.stream<i32, 17>) -> ()
    call @mac_r8(%arg3, %c0, %c0, %55, %46, %51, %45, %44) : (memref<4x4x4xi8, #map2>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    ...
    call @mac_r4(%arg3, %c1, %c0, %54, %36, %50, %35, %44, %34) : (memref<4x4x4xi8, #map2>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    ...
    call @mac_r4(%arg3, %c2, %c0, %53, %26, %49, %25, %34, %24) : (memref<4x4x4xi8, #map2>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
    ...
    call @mac_r7(%arg3, %c3, %c0, %52, %16, %48, %15, %24, %14) : (memref<4x4x4xi8, #map2>, index, index, !allo.stream<i8, 8>, !allo.stream<i8, 2>, !allo.stream<i32, 9>, !allo.stream<i32, 2>, !allo.stream<i32, 2>, !allo.stream<i32, 2>) -> ()
