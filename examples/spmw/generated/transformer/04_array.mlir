...
module {
  func.func @mac_a_in_load_0(%arg0: memref<8x4xi8, #map>, %arg1: !allo.stream<i8, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 0] {from = "local_A"} : memref<8x4xi8, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i8, 2> contains i8
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_a_in_load_1(%arg0: memref<8x4xi8, #map>, %arg1: !allo.stream<i8, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 1] {from = "local_A"} : memref<8x4xi8, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i8, 2> contains i8
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_a_in_load_2(%arg0: memref<8x4xi8, #map>, %arg1: !allo.stream<i8, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 2] {from = "local_A"} : memref<8x4xi8, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i8, 2> contains i8
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_a_in_load_3(%arg0: memref<8x4xi8, #map>, %arg1: !allo.stream<i8, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 3] {from = "local_A"} : memref<8x4xi8, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i8, 2> contains i8
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_op_in_load_0(%arg0: memref<8x4xi32, #map>, %arg1: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 0] {from = "local_MProg"} : memref<8x4xi32, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i32, 2> contains i32
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_op_in_load_1(%arg0: memref<8x4xi32, #map>, %arg1: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 1] {from = "local_MProg"} : memref<8x4xi32, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i32, 2> contains i32
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_op_in_load_2(%arg0: memref<8x4xi32, #map>, %arg1: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 2] {from = "local_MProg"} : memref<8x4xi32, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i32, 2> contains i32
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  func.func @mac_op_in_load_3(%arg0: memref<8x4xi32, #map>, %arg1: !allo.stream<i32, 2>) attributes {df.kernel, itypes = "s_", otypes = "", stypes = "_o"} {
    affine.for %arg2 = 0 to 8 {
      %0 = affine.load %arg0[%arg2, 3] {from = "local_MProg"} : memref<8x4xi32, #map>
      allo.stream_put(%arg1, [], %0) : !allo.stream<i32, 2> contains i32
    } {loop_name = "_t", op_name = "S__t_0", pipeline_ii = 1 : ui32}
    return
  }
  ...
  func.func @top(%arg0: memref<8x4xi8, #map>, %arg1: memref<8x4xi32, #map>, %arg2: memref<16xi32, #map1>, %arg3: memref<4x4x4xi8, #map2>, %arg4: memref<4x2xi32, #map>, %arg5: memref<4x4xi32, #map>) attributes {dataflow, itypes = "ssssss", top} {
    ...
    call @mac_a_in_load_0(%arg0, %52) : (memref<8x4xi8, #map>, !allo.stream<i8, 2>) -> ()
    call @mac_a_in_load_1(%arg0, %53) : (memref<8x4xi8, #map>, !allo.stream<i8, 2>) -> ()
    call @mac_a_in_load_2(%arg0, %54) : (memref<8x4xi8, #map>, !allo.stream<i8, 2>) -> ()
    call @mac_a_in_load_3(%arg0, %55) : (memref<8x4xi8, #map>, !allo.stream<i8, 2>) -> ()
    call @mac_op_in_load_0(%arg1, %56) : (memref<8x4xi32, #map>, !allo.stream<i32, 2>) -> ()
    call @mac_op_in_load_1(%arg1, %57) : (memref<8x4xi32, #map>, !allo.stream<i32, 2>) -> ()
    call @mac_op_in_load_2(%arg1, %58) : (memref<8x4xi32, #map>, !allo.stream<i32, 2>) -> ()
    call @mac_op_in_load_3(%arg1, %59) : (memref<8x4xi32, #map>, !allo.stream<i32, 2>) -> ()
