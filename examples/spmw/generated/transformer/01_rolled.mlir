module {
  ...
  func.func @top(%arg0: memref<8x4xi8>, %arg1: memref<9x4xi32>, %arg2: memref<17xi32>, %arg3: memref<4x4x4xi8>, %arg4: memref<4x2xi32>, %arg5: memref<4x4xi32>) attributes {dataflow, itypes = "ssssss", otypes = ""} {
    spmw.map(%arg0) topology = <grid = [4], families = [#spmw.family<name = "mac_a_in_bind", type = i8, block = [], depth = 8, shape = [4]>], ports = [#spmw.port_map<port = "chan", family = "mac_a_in_bind", kind = "table", slots = dense<[0, 1, 2, 3]> : tensor<4xi32>>]> roles = [#spmw.role<unit = @mac_a_in_load, missing = [], ports = ["chan"]>] classes = dense<0> : tensor<4xi32> : memref<8x4xi8>
    spmw.map(%arg1) topology = <grid = [4], families = [#spmw.family<name = "mac_op_in_bind", type = i32, block = [], depth = 9, shape = [4]>], ports = [#spmw.port_map<port = "chan", family = "mac_op_in_bind", kind = "table", slots = dense<[0, 1, 2, 3]> : tensor<4xi32>>]> roles = [#spmw.role<unit = @mac_op_in_load, missing = [], ports = ["chan"]>] classes = dense<0> : tensor<4xi32> : memref<9x4xi32>
