...
**The pipeline.**  Vitis charges each FIFO access 1.42 ns, so it cannot fit
read, multiply, add and write in one 3.33 ns stage and registers the cell
three stages deep -- ``a``, ``p``, the product and the sum -- *on top of* the
