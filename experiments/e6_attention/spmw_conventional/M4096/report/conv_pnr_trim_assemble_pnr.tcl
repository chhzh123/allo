...
set root /scratch/hc676/e6_work/conv_4096_pnr_trim
add_files [glob $root/*.sv]
foreach r {mac_r0 mac_r1 mac_r2 mac_r3 mac_r4 mac_r5 mac_r6 mac_r7 mac_r8 drain_r0} {
  set d $root/$r
...
add_files -fileset constrs_1 /scratch/hc676/e6_work/conv_4096_pnr_trim/clock.xdc
