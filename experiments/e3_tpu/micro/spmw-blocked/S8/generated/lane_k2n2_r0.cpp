...
void lane_k2n2_r0_0(
  hls::stream< hls::vector< int32_t, 3 > >& v0,
  hls::stream< int32_t >& v1,
  hls::stream< int32_t >& v2
) {	// L2
  int32_t v3[3];
  {
    hls::vector< int32_t, 3 > _vec = v0.read();
  ...
  int32_t r15;	// L40
  r15 = 0;	// L41
  l_S_s_0_s: for (int s = 0; s < 1024; s++) {	// L42
  #pragma HLS pipeline II=1
    int v24 = s >> 4;	// L45
    ap_int<33> v25 = v24;	// L51
    ap_int<33> v26 = v25 & 1;	// L52
    int32_t v27 = v26;	// L53
    int32_t kb;	// L54
    kb = v27;	// L55
    int v29 = s >> 5;	// L59
    ap_int<33> v30 = v29;	// L60
    ap_int<33> v31 = v30 & 1;	// L61
    int32_t v32 = v31;	// L62
    int32_t nb;	// L63
    nb = v32;	// L64
