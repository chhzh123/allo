...
module spmw_harness (
  ...
  endgenerate
  wire [31:0] lane_k4n4_y_out_bind_din [0:3];
  wire lane_k4n4_y_out_bind_write [0:3];
  wire lane_k4n4_y_out_bind_full_n [0:3];
  genvar g_lane_k4n4_y_out_bind;
  generate
    for (g_lane_k4n4_y_out_bind = 0; g_lane_k4n4_y_out_bind < 4; g_lane_k4n4_y_out_bind = g_lane_k4n4_y_out_bind + 1) begin : gen_lane_k4n4_y_out_bind
      assign lane_k4n4_y_out_bind_full_n[g_lane_k4n4_y_out_bind] = 1'b1;
    end
  endgenerate
  wire [159:0] lane_k4n4_b_mem_dout [0:3];
  wire lane_k4n4_b_mem_empty_n [0:3];
  wire lane_k4n4_b_mem_read [0:3];
  genvar g_lane_k4n4_b_mem;
  generate
    for (g_lane_k4n4_b_mem = 0; g_lane_k4n4_b_mem < 4; g_lane_k4n4_b_mem = g_lane_k4n4_b_mem + 1) begin : gen_lane_k4n4_b_mem
      reg [31:0] lf_lane_k4n4_b_mem;
      always @(posedge ap_clk)
        if (!ap_rst_n) lf_lane_k4n4_b_mem <= 32'h1 + g_lane_k4n4_b_mem;
        else if (start) lf_lane_k4n4_b_mem <= {lf_lane_k4n4_b_mem[30:0], lf_lane_k4n4_b_mem[31]^lf_lane_k4n4_b_mem[21]^lf_lane_k4n4_b_mem[1]^lf_lane_k4n4_b_mem[0]};
      assign lane_k4n4_b_mem_dout[g_lane_k4n4_b_mem] = {5{lf_lane_k4n4_b_mem}};
      assign lane_k4n4_b_mem_empty_n[g_lane_k4n4_b_mem] = start;
    end
  endgenerate
  ...
  spmw_top dut (
      ...
      .lane_k4n4_y_out_bind_din(lane_k4n4_y_out_bind_din),
      .lane_k4n4_y_out_bind_write(lane_k4n4_y_out_bind_write),
      .lane_k4n4_y_out_bind_full_n(lane_k4n4_y_out_bind_full_n),
      .lane_k4n4_b_mem_dout(lane_k4n4_b_mem_dout),
      .lane_k4n4_b_mem_empty_n(lane_k4n4_b_mem_empty_n),
      .lane_k4n4_b_mem_read(lane_k4n4_b_mem_read));
  ...
  always @(posedge ap_clk)
    if (!ap_rst_n) sig <= 32'b0;
      ...
      ^ lane_k4n4_y_out_bind_din[0][31:0]
      ^ {31'b0, lane_k4n4_y_out_bind_write[0]}
      ^ lane_k4n4_y_out_bind_din[1][31:0]
      ^ {31'b0, lane_k4n4_y_out_bind_write[1]}
      ^ lane_k4n4_y_out_bind_din[2][31:0]
      ^ {31'b0, lane_k4n4_y_out_bind_write[2]}
      ^ lane_k4n4_y_out_bind_din[3][31:0]
      ^ {31'b0, lane_k4n4_y_out_bind_write[3]}
      ^ {31'b0, lane_k4n4_b_mem_read[0]}
      ;
endmodule
