...
module spmw_top (
  ...
  output wire [31:0] lane_k4n4_y_out_bind_din [0:3],
  output wire lane_k4n4_y_out_bind_write [0:3],
  input  wire lane_k4n4_y_out_bind_full_n [0:3],
  input  wire [159:0] lane_k4n4_b_mem_dout [0:3],
  input  wire lane_k4n4_b_mem_empty_n [0:3],
  output wire lane_k4n4_b_mem_read [0:3]
);
  ...
  endgenerate
  // family lane_k4n4_z_in_bind: 4 channel(s), 32-bit, depth 2
  wire [31:0] lane_k4n4_z_in_bind_din [0:3];
  wire [31:0] lane_k4n4_z_in_bind_dout [0:3];
  wire lane_k4n4_z_in_bind_full_n [0:3];
  wire lane_k4n4_z_in_bind_write [0:3];
  wire lane_k4n4_z_in_bind_empty_n [0:3];
  wire lane_k4n4_z_in_bind_read [0:3];
  genvar lane_k4n4_z_in_bind_i;
  generate
    for (lane_k4n4_z_in_bind_i = 0; lane_k4n4_z_in_bind_i < 4; lane_k4n4_z_in_bind_i = lane_k4n4_z_in_bind_i + 1) begin : g_lane_k4n4_z_in_bind
      spmw_fifo #(.DW(32), .DEPTH(2)) u (.clk(ap_clk), .rst_n(ap_rst_n), .din(lane_k4n4_z_in_bind_din[lane_k4n4_z_in_bind_i]), .full_n(lane_k4n4_z_in_bind_full_n[lane_k4n4_z_in_bind_i]), .write(lane_k4n4_z_in_bind_write[lane_k4n4_z_in_bind_i]), .dout(lane_k4n4_z_in_bind_dout[lane_k4n4_z_in_bind_i]), .empty_n(lane_k4n4_z_in_bind_empty_n[lane_k4n4_z_in_bind_i]), .read(lane_k4n4_z_in_bind_read[lane_k4n4_z_in_bind_i]));
    end
  endgenerate
  ...
  pe_r1 u_pe_r1_3_1 (
      ...
      .p_out_din(lane_k4n4_z_in_bind_din[1]),
      .p_out_full_n(lane_k4n4_z_in_bind_full_n[1]),
      .p_out_write(lane_k4n4_z_in_bind_write[1]),
  ...
  pe_r1 u_pe_r1_3_2 (
      ...
      .p_out_din(lane_k4n4_z_in_bind_din[2]),
      .p_out_full_n(lane_k4n4_z_in_bind_full_n[2]),
      .p_out_write(lane_k4n4_z_in_bind_write[2]),
  ...
  pe_r5 u_pe_r5_3_3 (
      ...
      .p_out_din(lane_k4n4_z_in_bind_din[3]),
      .p_out_full_n(lane_k4n4_z_in_bind_full_n[3]),
      .p_out_write(lane_k4n4_z_in_bind_write[3]),
  ...
  pe_r7 u_pe_r7_3_0 (
      ...
      .p_out_din(lane_k4n4_z_in_bind_din[0]),
      .p_out_full_n(lane_k4n4_z_in_bind_full_n[0]),
      .p_out_write(lane_k4n4_z_in_bind_write[0]),
  ...
  // role lane_k4n4_r0: 4 instance(s)
  lane_k4n4_r0 u_lane_k4n4_r0_0 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lane_k4n4_b_mem_dout[0]),
      .b_empty_n(lane_k4n4_b_mem_empty_n[0]),
      .b_read(lane_k4n4_b_mem_read[0]),
      .y_out_din(lane_k4n4_y_out_bind_din[0]),
      .y_out_full_n(lane_k4n4_y_out_bind_full_n[0]),
      .y_out_write(lane_k4n4_y_out_bind_write[0]),
      .z_in_dout(lane_k4n4_z_in_bind_dout[0]),
      .z_in_empty_n(lane_k4n4_z_in_bind_empty_n[0]),
      .z_in_read(lane_k4n4_z_in_bind_read[0]));
  lane_k4n4_r0 u_lane_k4n4_r0_1 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lane_k4n4_b_mem_dout[1]),
      .b_empty_n(lane_k4n4_b_mem_empty_n[1]),
      .b_read(lane_k4n4_b_mem_read[1]),
      .y_out_din(lane_k4n4_y_out_bind_din[1]),
      .y_out_full_n(lane_k4n4_y_out_bind_full_n[1]),
      .y_out_write(lane_k4n4_y_out_bind_write[1]),
      .z_in_dout(lane_k4n4_z_in_bind_dout[1]),
      .z_in_empty_n(lane_k4n4_z_in_bind_empty_n[1]),
      .z_in_read(lane_k4n4_z_in_bind_read[1]));
  lane_k4n4_r0 u_lane_k4n4_r0_2 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lane_k4n4_b_mem_dout[2]),
      .b_empty_n(lane_k4n4_b_mem_empty_n[2]),
      .b_read(lane_k4n4_b_mem_read[2]),
      .y_out_din(lane_k4n4_y_out_bind_din[2]),
      .y_out_full_n(lane_k4n4_y_out_bind_full_n[2]),
      .y_out_write(lane_k4n4_y_out_bind_write[2]),
      .z_in_dout(lane_k4n4_z_in_bind_dout[2]),
      .z_in_empty_n(lane_k4n4_z_in_bind_empty_n[2]),
      .z_in_read(lane_k4n4_z_in_bind_read[2]));
  lane_k4n4_r0 u_lane_k4n4_r0_3 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lane_k4n4_b_mem_dout[3]),
      .b_empty_n(lane_k4n4_b_mem_empty_n[3]),
      .b_read(lane_k4n4_b_mem_read[3]),
      .y_out_din(lane_k4n4_y_out_bind_din[3]),
      .y_out_full_n(lane_k4n4_y_out_bind_full_n[3]),
      .y_out_write(lane_k4n4_y_out_bind_write[3]),
      .z_in_dout(lane_k4n4_z_in_bind_dout[3]),
      .z_in_empty_n(lane_k4n4_z_in_bind_empty_n[3]),
      .z_in_read(lane_k4n4_z_in_bind_read[3]));
endmodule
