...
module spmw_top (
  ...
  // family mac_a_out_a_in: 16 channel(s), 8-bit, depth 4
  ...
  endgenerate
  // family mac_p_out_p_in: 16 channel(s), 32-bit, depth 4
  ...
  endgenerate
  // family vpu_z_in_bind: 4 channel(s), 32-bit, depth 4
