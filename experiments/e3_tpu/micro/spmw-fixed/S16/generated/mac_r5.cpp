...
void mac_r5_0(
  ...
  l_S_r_2_r: for (int r = 0; r < 256; r++) {	// L32
    ...
    #pragma HLS bind_op variable=v50 op=mul impl=fabric
...
void top(
  ...
  #pragma HLS stream variable=v57 depth=4	// L83
  mac_r5_0(v57, v54, v55, v56);	// L84
}
