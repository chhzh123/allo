...
module spmw_harness (
  ...
  endgenerate
  wire [31:0] mac_op_in_bind_dout [0:15];
  wire mac_op_in_bind_empty_n [0:15];
  wire mac_op_in_bind_read [0:15];
  genvar g_mac_op_in_bind;
  generate
    for (g_mac_op_in_bind = 0; g_mac_op_in_bind < 16; g_mac_op_in_bind = g_mac_op_in_bind + 1) begin : gen_mac_op_in_bind
