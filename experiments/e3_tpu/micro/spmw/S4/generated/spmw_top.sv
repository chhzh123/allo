...
module spmw_top (
  ...
  input  wire [31:0] mac_w_in_bind_dout [0:3],
  input  wire mac_w_in_bind_empty_n [0:3],
  output wire mac_w_in_bind_read [0:3],
  input  wire [31:0] mac_op_in_bind_dout [0:3],
  input  wire mac_op_in_bind_empty_n [0:3],
  output wire mac_op_in_bind_read [0:3],
  ...
  input  wire [63:0] vpu_b_mem_dout [0:3],
  ...
  endgenerate
  // family mac_op_out_op_in: 16 channel(s), 32-bit, depth 2
  wire [31:0] mac_op_out_op_in_din [0:15];
  wire [31:0] mac_op_out_op_in_dout [0:15];
  wire mac_op_out_op_in_full_n [0:15];
  wire mac_op_out_op_in_write [0:15];
  wire mac_op_out_op_in_empty_n [0:15];
  wire mac_op_out_op_in_read [0:15];
  genvar mac_op_out_op_in_i;
  generate
    for (mac_op_out_op_in_i = 0; mac_op_out_op_in_i < 16; mac_op_out_op_in_i = mac_op_out_op_in_i + 1) begin : g_mac_op_out_op_in
  ...
  endgenerate
  // family mac_w_out_w_in: 16 channel(s), 32-bit, depth 2
  wire [31:0] mac_w_out_w_in_din [0:15];
  wire [31:0] mac_w_out_w_in_dout [0:15];
  wire mac_w_out_w_in_full_n [0:15];
  wire mac_w_out_w_in_write [0:15];
  wire mac_w_out_w_in_empty_n [0:15];
  wire mac_w_out_w_in_read [0:15];
  genvar mac_w_out_w_in_i;
  generate
    for (mac_w_out_w_in_i = 0; mac_w_out_w_in_i < 16; mac_w_out_w_in_i = mac_w_out_w_in_i + 1) begin : g_mac_w_out_w_in
