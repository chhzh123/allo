...
module spmw_top (
  ...
  // family pe_a_out_a_in: 16 channel(s), 8-bit, depth 2
  ...
  endgenerate
  // family pe_w_out_w_in: 16 channel(s), 8-bit, depth 2
  ...
  generate
    for (pe_w_out_w_in_i = 0; pe_w_out_w_in_i < 16; pe_w_out_w_in_i = pe_w_out_w_in_i + 1) begin : g_pe_w_out_w_in
      spmw_fifo #(.DW(8), .DEPTH(2)) u (.clk(ap_clk), .rst_n(ap_rst_n), .din(pe_w_out_w_in_din[pe_w_out_w_in_i]), .full_n(pe_w_out_w_in_full_n[pe_w_out_w_in_i]), .write(pe_w_out_w_in_write[pe_w_out_w_in_i]), .dout(pe_w_out_w_in_dout[pe_w_out_w_in_i]), .empty_n(pe_w_out_w_in_empty_n[pe_w_out_w_in_i]), .read(pe_w_out_w_in_read[pe_w_out_w_in_i]));
    end
  endgenerate
  // family pe_p_out_p_in: 16 channel(s), 32-bit, depth 2
  ...
  generate
    for (pe_p_out_p_in_i = 0; pe_p_out_p_in_i < 16; pe_p_out_p_in_i = pe_p_out_p_in_i + 1) begin : g_pe_p_out_p_in
      spmw_fifo #(.DW(32), .DEPTH(2)) u (.clk(ap_clk), .rst_n(ap_rst_n), .din(pe_p_out_p_in_din[pe_p_out_p_in_i]), .full_n(pe_p_out_p_in_full_n[pe_p_out_p_in_i]), .write(pe_p_out_p_in_write[pe_p_out_p_in_i]), .dout(pe_p_out_p_in_dout[pe_p_out_p_in_i]), .empty_n(pe_p_out_p_in_empty_n[pe_p_out_p_in_i]), .read(pe_p_out_p_in_read[pe_p_out_p_in_i]));
    end
  endgenerate
