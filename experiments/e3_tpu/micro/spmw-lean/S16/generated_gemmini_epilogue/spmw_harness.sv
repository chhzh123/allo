...
module spmw_harness (
  ...
  endgenerate
  wire [31:0] pe_p_in_bind_dout [0:15];
  wire pe_p_in_bind_empty_n [0:15];
  wire pe_p_in_bind_read [0:15];
  genvar g_pe_p_in_bind;
  generate
    for (g_pe_p_in_bind = 0; g_pe_p_in_bind < 16; g_pe_p_in_bind = g_pe_p_in_bind + 1) begin : gen_pe_p_in_bind
      reg [31:0] lf_pe_p_in_bind;
      always @(posedge ap_clk)
        if (!ap_rst_n) lf_pe_p_in_bind <= 32'h1 + g_pe_p_in_bind;
        else if (start) lf_pe_p_in_bind <= {lf_pe_p_in_bind[30:0], lf_pe_p_in_bind[31]^lf_pe_p_in_bind[21]^lf_pe_p_in_bind[1]^lf_pe_p_in_bind[0]};
      assign pe_p_in_bind_dout[g_pe_p_in_bind] = lf_pe_p_in_bind[31:0];
      assign pe_p_in_bind_empty_n[g_pe_p_in_bind] = start;
    end
  endgenerate
  ...
  spmw_top dut (
      ...
      .pe_p_in_bind_dout(pe_p_in_bind_dout),
      .pe_p_in_bind_empty_n(pe_p_in_bind_empty_n),
      .pe_p_in_bind_read(pe_p_in_bind_read),
