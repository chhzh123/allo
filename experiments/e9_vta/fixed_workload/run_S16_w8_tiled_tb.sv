...
`timescale 1ns/1ps
module tb;
  localparam DIM = 8, NT = 16, NACC = 512, SHIFT = 8;
  localparam NINP = 512, NWGT = 64, NUOP = 64, TILED = 1;
  localparam NBM = 32, KBM = 32, KBNB = 4;  // one tile's rows
  ...
  TensorGemm gemm (
    ...
    .io_dec_wgt_1(10'd0), .io_dec_wgt_0(10'd4),
    .io_dec_inp_1(11'd0), .io_dec_inp_0(11'd32),
    .io_dec_acc_1(11'd0), .io_dec_acc_0(11'd32),
    .io_dec_empty_0(1'b0),
  ...
  TensorAlu alu (
    ...
    .io_dec_src_1(11'd0), .io_dec_src_0(11'd32),
    .io_dec_dst_1(11'd0), .io_dec_dst_0(11'd32),
    .io_dec_empty_0(1'b0),
    .io_dec_lp_1(14'd1), .io_dec_lp_0(TILED ? 14'd1 : 14'd16),
    .io_dec_uop_end(14'd32), .io_dec_uop_begin(13'd0),
    .io_dec_reset(1'b0), .io_dec_push_next(1'b0), .io_dec_push_prev(1'b0),
    .io_dec_pop_next(1'b0), .io_dec_pop_prev(1'b0), .io_dec_op(3'd0),
