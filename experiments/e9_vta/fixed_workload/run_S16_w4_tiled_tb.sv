...
`timescale 1ns/1ps
module tb;
  localparam DIM = 4, NT = 16, NACC = 1024, SHIFT = 8;
  localparam NINP = 1024, NWGT = 256, NUOP = 256, TILED = 1;
  localparam NBM = 64, KBM = 64, KBNB = 16;  // one tile's rows
  ...
  TensorGemm gemm (
    ...
    .io_dec_wgt_1(10'd0), .io_dec_wgt_0(10'd16),
    .io_dec_inp_1(11'd0), .io_dec_inp_0(11'd64),
    .io_dec_acc_1(11'd0), .io_dec_acc_0(11'd64),
    .io_dec_empty_0(1'b0),
    .io_dec_lp_1(14'd1), .io_dec_lp_0(TILED ? 14'd1 : 14'd16),
    .io_dec_uop_end(14'd256), .io_dec_uop_begin(13'd0),
