...
`timescale 1ns/1ps
module tb;
  localparam DIM = 16, NT = 16, NACC = 256, SHIFT = 8;
  localparam NINP = 256, NWGT = 16, NUOP = 16, TILED = 0;
  localparam NBM = 16, KBM = 16, KBNB = 1;  // one tile's rows
  ...
  TensorGemm gemm (
    ...
    .io_dec_inp_1(11'd0), .io_dec_inp_0(11'd16),
    .io_dec_acc_1(11'd0), .io_dec_acc_0(11'd16),
    .io_dec_empty_0(1'b0),
    .io_dec_lp_1(14'd1), .io_dec_lp_0(TILED ? 14'd1 : 14'd16),
    .io_dec_uop_end(14'd16), .io_dec_uop_begin(13'd0),
  ...
  TensorAlu alu (
    ...
    .io_dec_src_1(11'd0), .io_dec_src_0(11'd16),
    .io_dec_dst_1(11'd0), .io_dec_dst_0(11'd16),
    .io_dec_empty_0(1'b0),
    .io_dec_lp_1(14'd1), .io_dec_lp_0(TILED ? 14'd1 : 14'd16),
    .io_dec_uop_end(14'd16), .io_dec_uop_begin(13'd0),
    .io_dec_reset(1'b0), .io_dec_push_next(1'b0), .io_dec_push_prev(1'b0),
  ...
  always @(posedge clk) begin
    ...
    if (g_inp_iv) begin
        ...
        inp_d[8] <= inpm[inp_ib][8];
        inp_d[9] <= inpm[inp_ib][9];
        inp_d[10] <= inpm[inp_ib][10];
        inp_d[11] <= inpm[inp_ib][11];
        inp_d[12] <= inpm[inp_ib][12];
        inp_d[13] <= inpm[inp_ib][13];
        inp_d[14] <= inpm[inp_ib][14];
        inp_d[15] <= inpm[inp_ib][15];
    end
    wgt_dv <= g_wgt_iv;
    if (g_wgt_iv) begin
        ...
        wgt_d[0][8] <= wgtm[wgt_ib][0][8];
        wgt_d[0][9] <= wgtm[wgt_ib][0][9];
        wgt_d[0][10] <= wgtm[wgt_ib][0][10];
        wgt_d[0][11] <= wgtm[wgt_ib][0][11];
        wgt_d[0][12] <= wgtm[wgt_ib][0][12];
        wgt_d[0][13] <= wgtm[wgt_ib][0][13];
        wgt_d[0][14] <= wgtm[wgt_ib][0][14];
        wgt_d[0][15] <= wgtm[wgt_ib][0][15];
        ...
        wgt_d[1][8] <= wgtm[wgt_ib][1][8];
        wgt_d[1][9] <= wgtm[wgt_ib][1][9];
        wgt_d[1][10] <= wgtm[wgt_ib][1][10];
        wgt_d[1][11] <= wgtm[wgt_ib][1][11];
        wgt_d[1][12] <= wgtm[wgt_ib][1][12];
        wgt_d[1][13] <= wgtm[wgt_ib][1][13];
        wgt_d[1][14] <= wgtm[wgt_ib][1][14];
        wgt_d[1][15] <= wgtm[wgt_ib][1][15];
        ...
        wgt_d[2][8] <= wgtm[wgt_ib][2][8];
        wgt_d[2][9] <= wgtm[wgt_ib][2][9];
        wgt_d[2][10] <= wgtm[wgt_ib][2][10];
        wgt_d[2][11] <= wgtm[wgt_ib][2][11];
        wgt_d[2][12] <= wgtm[wgt_ib][2][12];
        wgt_d[2][13] <= wgtm[wgt_ib][2][13];
        wgt_d[2][14] <= wgtm[wgt_ib][2][14];
        wgt_d[2][15] <= wgtm[wgt_ib][2][15];
        ...
        wgt_d[3][8] <= wgtm[wgt_ib][3][8];
        wgt_d[3][9] <= wgtm[wgt_ib][3][9];
        wgt_d[3][10] <= wgtm[wgt_ib][3][10];
        wgt_d[3][11] <= wgtm[wgt_ib][3][11];
        wgt_d[3][12] <= wgtm[wgt_ib][3][12];
        wgt_d[3][13] <= wgtm[wgt_ib][3][13];
        wgt_d[3][14] <= wgtm[wgt_ib][3][14];
        wgt_d[3][15] <= wgtm[wgt_ib][3][15];
        ...
        wgt_d[4][8] <= wgtm[wgt_ib][4][8];
        wgt_d[4][9] <= wgtm[wgt_ib][4][9];
        wgt_d[4][10] <= wgtm[wgt_ib][4][10];
        wgt_d[4][11] <= wgtm[wgt_ib][4][11];
        wgt_d[4][12] <= wgtm[wgt_ib][4][12];
        wgt_d[4][13] <= wgtm[wgt_ib][4][13];
        wgt_d[4][14] <= wgtm[wgt_ib][4][14];
        wgt_d[4][15] <= wgtm[wgt_ib][4][15];
        ...
        wgt_d[5][8] <= wgtm[wgt_ib][5][8];
        wgt_d[5][9] <= wgtm[wgt_ib][5][9];
        wgt_d[5][10] <= wgtm[wgt_ib][5][10];
        wgt_d[5][11] <= wgtm[wgt_ib][5][11];
        wgt_d[5][12] <= wgtm[wgt_ib][5][12];
        wgt_d[5][13] <= wgtm[wgt_ib][5][13];
        wgt_d[5][14] <= wgtm[wgt_ib][5][14];
        wgt_d[5][15] <= wgtm[wgt_ib][5][15];
        ...
        wgt_d[6][8] <= wgtm[wgt_ib][6][8];
        wgt_d[6][9] <= wgtm[wgt_ib][6][9];
        wgt_d[6][10] <= wgtm[wgt_ib][6][10];
        wgt_d[6][11] <= wgtm[wgt_ib][6][11];
        wgt_d[6][12] <= wgtm[wgt_ib][6][12];
        wgt_d[6][13] <= wgtm[wgt_ib][6][13];
        wgt_d[6][14] <= wgtm[wgt_ib][6][14];
        wgt_d[6][15] <= wgtm[wgt_ib][6][15];
        ...
        wgt_d[7][8] <= wgtm[wgt_ib][7][8];
        wgt_d[7][9] <= wgtm[wgt_ib][7][9];
        wgt_d[7][10] <= wgtm[wgt_ib][7][10];
        wgt_d[7][11] <= wgtm[wgt_ib][7][11];
        wgt_d[7][12] <= wgtm[wgt_ib][7][12];
        wgt_d[7][13] <= wgtm[wgt_ib][7][13];
        wgt_d[7][14] <= wgtm[wgt_ib][7][14];
        wgt_d[7][15] <= wgtm[wgt_ib][7][15];
        wgt_d[8][0] <= wgtm[wgt_ib][8][0];
        wgt_d[8][1] <= wgtm[wgt_ib][8][1];
        wgt_d[8][2] <= wgtm[wgt_ib][8][2];
        wgt_d[8][3] <= wgtm[wgt_ib][8][3];
        wgt_d[8][4] <= wgtm[wgt_ib][8][4];
        wgt_d[8][5] <= wgtm[wgt_ib][8][5];
        wgt_d[8][6] <= wgtm[wgt_ib][8][6];
        wgt_d[8][7] <= wgtm[wgt_ib][8][7];
        wgt_d[8][8] <= wgtm[wgt_ib][8][8];
        wgt_d[8][9] <= wgtm[wgt_ib][8][9];
        wgt_d[8][10] <= wgtm[wgt_ib][8][10];
        wgt_d[8][11] <= wgtm[wgt_ib][8][11];
        wgt_d[8][12] <= wgtm[wgt_ib][8][12];
        wgt_d[8][13] <= wgtm[wgt_ib][8][13];
        wgt_d[8][14] <= wgtm[wgt_ib][8][14];
        wgt_d[8][15] <= wgtm[wgt_ib][8][15];
        wgt_d[9][0] <= wgtm[wgt_ib][9][0];
        wgt_d[9][1] <= wgtm[wgt_ib][9][1];
        wgt_d[9][2] <= wgtm[wgt_ib][9][2];
        wgt_d[9][3] <= wgtm[wgt_ib][9][3];
        wgt_d[9][4] <= wgtm[wgt_ib][9][4];
        wgt_d[9][5] <= wgtm[wgt_ib][9][5];
        wgt_d[9][6] <= wgtm[wgt_ib][9][6];
        wgt_d[9][7] <= wgtm[wgt_ib][9][7];
        wgt_d[9][8] <= wgtm[wgt_ib][9][8];
        wgt_d[9][9] <= wgtm[wgt_ib][9][9];
        wgt_d[9][10] <= wgtm[wgt_ib][9][10];
        wgt_d[9][11] <= wgtm[wgt_ib][9][11];
        wgt_d[9][12] <= wgtm[wgt_ib][9][12];
        wgt_d[9][13] <= wgtm[wgt_ib][9][13];
        wgt_d[9][14] <= wgtm[wgt_ib][9][14];
        wgt_d[9][15] <= wgtm[wgt_ib][9][15];
        wgt_d[10][0] <= wgtm[wgt_ib][10][0];
        wgt_d[10][1] <= wgtm[wgt_ib][10][1];
        wgt_d[10][2] <= wgtm[wgt_ib][10][2];
        wgt_d[10][3] <= wgtm[wgt_ib][10][3];
        wgt_d[10][4] <= wgtm[wgt_ib][10][4];
        wgt_d[10][5] <= wgtm[wgt_ib][10][5];
        wgt_d[10][6] <= wgtm[wgt_ib][10][6];
        wgt_d[10][7] <= wgtm[wgt_ib][10][7];
        wgt_d[10][8] <= wgtm[wgt_ib][10][8];
        wgt_d[10][9] <= wgtm[wgt_ib][10][9];
        wgt_d[10][10] <= wgtm[wgt_ib][10][10];
        wgt_d[10][11] <= wgtm[wgt_ib][10][11];
        wgt_d[10][12] <= wgtm[wgt_ib][10][12];
        wgt_d[10][13] <= wgtm[wgt_ib][10][13];
        wgt_d[10][14] <= wgtm[wgt_ib][10][14];
        wgt_d[10][15] <= wgtm[wgt_ib][10][15];
        wgt_d[11][0] <= wgtm[wgt_ib][11][0];
        wgt_d[11][1] <= wgtm[wgt_ib][11][1];
        wgt_d[11][2] <= wgtm[wgt_ib][11][2];
        wgt_d[11][3] <= wgtm[wgt_ib][11][3];
        wgt_d[11][4] <= wgtm[wgt_ib][11][4];
        wgt_d[11][5] <= wgtm[wgt_ib][11][5];
        wgt_d[11][6] <= wgtm[wgt_ib][11][6];
        wgt_d[11][7] <= wgtm[wgt_ib][11][7];
        wgt_d[11][8] <= wgtm[wgt_ib][11][8];
        wgt_d[11][9] <= wgtm[wgt_ib][11][9];
        wgt_d[11][10] <= wgtm[wgt_ib][11][10];
        wgt_d[11][11] <= wgtm[wgt_ib][11][11];
        wgt_d[11][12] <= wgtm[wgt_ib][11][12];
        wgt_d[11][13] <= wgtm[wgt_ib][11][13];
        wgt_d[11][14] <= wgtm[wgt_ib][11][14];
        wgt_d[11][15] <= wgtm[wgt_ib][11][15];
        wgt_d[12][0] <= wgtm[wgt_ib][12][0];
        wgt_d[12][1] <= wgtm[wgt_ib][12][1];
        wgt_d[12][2] <= wgtm[wgt_ib][12][2];
        wgt_d[12][3] <= wgtm[wgt_ib][12][3];
        wgt_d[12][4] <= wgtm[wgt_ib][12][4];
        wgt_d[12][5] <= wgtm[wgt_ib][12][5];
        wgt_d[12][6] <= wgtm[wgt_ib][12][6];
        wgt_d[12][7] <= wgtm[wgt_ib][12][7];
        wgt_d[12][8] <= wgtm[wgt_ib][12][8];
        wgt_d[12][9] <= wgtm[wgt_ib][12][9];
        wgt_d[12][10] <= wgtm[wgt_ib][12][10];
        wgt_d[12][11] <= wgtm[wgt_ib][12][11];
        wgt_d[12][12] <= wgtm[wgt_ib][12][12];
        wgt_d[12][13] <= wgtm[wgt_ib][12][13];
        wgt_d[12][14] <= wgtm[wgt_ib][12][14];
        wgt_d[12][15] <= wgtm[wgt_ib][12][15];
        wgt_d[13][0] <= wgtm[wgt_ib][13][0];
        wgt_d[13][1] <= wgtm[wgt_ib][13][1];
        wgt_d[13][2] <= wgtm[wgt_ib][13][2];
        wgt_d[13][3] <= wgtm[wgt_ib][13][3];
        wgt_d[13][4] <= wgtm[wgt_ib][13][4];
        wgt_d[13][5] <= wgtm[wgt_ib][13][5];
        wgt_d[13][6] <= wgtm[wgt_ib][13][6];
        wgt_d[13][7] <= wgtm[wgt_ib][13][7];
        wgt_d[13][8] <= wgtm[wgt_ib][13][8];
        wgt_d[13][9] <= wgtm[wgt_ib][13][9];
        wgt_d[13][10] <= wgtm[wgt_ib][13][10];
        wgt_d[13][11] <= wgtm[wgt_ib][13][11];
        wgt_d[13][12] <= wgtm[wgt_ib][13][12];
        wgt_d[13][13] <= wgtm[wgt_ib][13][13];
        wgt_d[13][14] <= wgtm[wgt_ib][13][14];
        wgt_d[13][15] <= wgtm[wgt_ib][13][15];
        wgt_d[14][0] <= wgtm[wgt_ib][14][0];
        wgt_d[14][1] <= wgtm[wgt_ib][14][1];
        wgt_d[14][2] <= wgtm[wgt_ib][14][2];
        wgt_d[14][3] <= wgtm[wgt_ib][14][3];
        wgt_d[14][4] <= wgtm[wgt_ib][14][4];
        wgt_d[14][5] <= wgtm[wgt_ib][14][5];
        wgt_d[14][6] <= wgtm[wgt_ib][14][6];
        wgt_d[14][7] <= wgtm[wgt_ib][14][7];
        wgt_d[14][8] <= wgtm[wgt_ib][14][8];
        wgt_d[14][9] <= wgtm[wgt_ib][14][9];
        wgt_d[14][10] <= wgtm[wgt_ib][14][10];
        wgt_d[14][11] <= wgtm[wgt_ib][14][11];
        wgt_d[14][12] <= wgtm[wgt_ib][14][12];
        wgt_d[14][13] <= wgtm[wgt_ib][14][13];
        wgt_d[14][14] <= wgtm[wgt_ib][14][14];
        wgt_d[14][15] <= wgtm[wgt_ib][14][15];
        wgt_d[15][0] <= wgtm[wgt_ib][15][0];
        wgt_d[15][1] <= wgtm[wgt_ib][15][1];
        wgt_d[15][2] <= wgtm[wgt_ib][15][2];
        wgt_d[15][3] <= wgtm[wgt_ib][15][3];
        wgt_d[15][4] <= wgtm[wgt_ib][15][4];
        wgt_d[15][5] <= wgtm[wgt_ib][15][5];
        wgt_d[15][6] <= wgtm[wgt_ib][15][6];
        wgt_d[15][7] <= wgtm[wgt_ib][15][7];
        wgt_d[15][8] <= wgtm[wgt_ib][15][8];
        wgt_d[15][9] <= wgtm[wgt_ib][15][9];
        wgt_d[15][10] <= wgtm[wgt_ib][15][10];
        wgt_d[15][11] <= wgtm[wgt_ib][15][11];
        wgt_d[15][12] <= wgtm[wgt_ib][15][12];
        wgt_d[15][13] <= wgtm[wgt_ib][15][13];
        wgt_d[15][14] <= wgtm[wgt_ib][15][14];
        wgt_d[15][15] <= wgtm[wgt_ib][15][15];
    end
