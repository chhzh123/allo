...
`timescale 1ns/1ps
module tb;
  localparam DIM = 4, NT = 16, NACC = 64, SHIFT = 7;
  localparam NINP = 64, NWGT = 16, NUOP = 4, TILED = 0;
  localparam NBM = 4, KBM = 4, KBNB = 1;  // one tile's rows
  ...
  TensorGemm gemm (
    ...
    .io_dec_inp_1(11'd0), .io_dec_inp_0(11'd4),
    .io_dec_acc_1(11'd0), .io_dec_acc_0(11'd4),
    .io_dec_empty_0(1'b0),
    .io_dec_lp_1(14'd1), .io_dec_lp_0(TILED ? 14'd1 : 14'd16),
    .io_dec_uop_end(14'd4), .io_dec_uop_begin(13'd0),
  ...
  TensorAlu alu (
    ...
    .io_dec_src_1(11'd0), .io_dec_src_0(11'd4),
    .io_dec_dst_1(11'd0), .io_dec_dst_0(11'd4),
    .io_dec_empty_0(1'b0),
    .io_dec_lp_1(14'd1), .io_dec_lp_0(TILED ? 14'd1 : 14'd16),
    .io_dec_uop_end(14'd4), .io_dec_uop_begin(13'd0),
    .io_dec_reset(1'b0), .io_dec_push_next(1'b0), .io_dec_push_prev(1'b0),
