...
`timescale 1ns/1ps
module tb;
  localparam DIM = 8, L = 64, SHIFT = 12;
  localparam KB = 256, NB = 16, KBC = 32, NBC = 16;
  ...
  TensorAlu alu (
    ...
    .io_dec_empty_0(1'b0),
    .io_dec_lp_1(14'd1), .io_dec_lp_0(14'd16),
    .io_dec_uop_end(14'd64), .io_dec_uop_begin(13'd0),
