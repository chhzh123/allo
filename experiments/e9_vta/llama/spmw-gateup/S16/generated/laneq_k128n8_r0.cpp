...
void laneq_k128n8_r0_0(
  ...
  int32_t r63;	// L136
  r63 = 0;	// L137
  l_S_s_0_s: for (int s = 0; s < 65536; s++) {	// L138
  #pragma HLS pipeline II=1
    int v72 = s >> 6;	// L141
    ap_int<33> v73 = v72;	// L147
    ap_int<33> v74 = v73 & 127;	// L148
    ...
    if (v155) {	// L300
      ...
      v = v158;	// L304
      int32_t v159 = v;	// L305
      bool v160 = v159 < -128;	// L307
      if (v160) {	// L308
        v = -128;	// L309
      }
      int32_t v161 = v;	// L311
      bool v162 = v161 > 127;	// L313
      if (v162) {	// L314
        v = 127;	// L315
      }
      int32_t v163 = v;	// L317
