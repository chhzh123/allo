...
module spmw_harness (
  ...
  endgenerate
  wire [31:0] laneq_k512n32_y_out_bind_din [0:3];
  wire laneq_k512n32_y_out_bind_write [0:3];
  wire laneq_k512n32_y_out_bind_full_n [0:3];
  genvar g_laneq_k512n32_y_out_bind;
  generate
    for (g_laneq_k512n32_y_out_bind = 0; g_laneq_k512n32_y_out_bind < 4; g_laneq_k512n32_y_out_bind = g_laneq_k512n32_y_out_bind + 1) begin : gen_laneq_k512n32_y_out_bind
      assign laneq_k512n32_y_out_bind_full_n[g_laneq_k512n32_y_out_bind] = 1'b1;
    end
  endgenerate
  wire [31:0] laneq_k512n32_b_mem_dout [0:3];
  wire laneq_k512n32_b_mem_empty_n [0:3];
  wire laneq_k512n32_b_mem_read [0:3];
  genvar g_laneq_k512n32_b_mem;
  generate
    for (g_laneq_k512n32_b_mem = 0; g_laneq_k512n32_b_mem < 4; g_laneq_k512n32_b_mem = g_laneq_k512n32_b_mem + 1) begin : gen_laneq_k512n32_b_mem
      reg [31:0] lf_laneq_k512n32_b_mem;
      always @(posedge ap_clk)
        if (!ap_rst_n) lf_laneq_k512n32_b_mem <= 32'h1 + g_laneq_k512n32_b_mem;
        else if (start) lf_laneq_k512n32_b_mem <= {lf_laneq_k512n32_b_mem[30:0], lf_laneq_k512n32_b_mem[31]^lf_laneq_k512n32_b_mem[21]^lf_laneq_k512n32_b_mem[1]^lf_laneq_k512n32_b_mem[0]};
      assign laneq_k512n32_b_mem_dout[g_laneq_k512n32_b_mem] = lf_laneq_k512n32_b_mem[31:0];
      assign laneq_k512n32_b_mem_empty_n[g_laneq_k512n32_b_mem] = start;
    end
  endgenerate
  ...
  spmw_top dut (
      ...
      .laneq_k512n32_y_out_bind_din(laneq_k512n32_y_out_bind_din),
      .laneq_k512n32_y_out_bind_write(laneq_k512n32_y_out_bind_write),
      .laneq_k512n32_y_out_bind_full_n(laneq_k512n32_y_out_bind_full_n),
      .laneq_k512n32_b_mem_dout(laneq_k512n32_b_mem_dout),
      .laneq_k512n32_b_mem_empty_n(laneq_k512n32_b_mem_empty_n),
      .laneq_k512n32_b_mem_read(laneq_k512n32_b_mem_read));
  ...
  always @(posedge ap_clk)
    if (!ap_rst_n) sig <= 32'b0;
      ...
      ^ laneq_k512n32_y_out_bind_din[0][31:0]
      ^ {31'b0, laneq_k512n32_y_out_bind_write[0]}
      ^ laneq_k512n32_y_out_bind_din[1][31:0]
      ^ {31'b0, laneq_k512n32_y_out_bind_write[1]}
      ^ laneq_k512n32_y_out_bind_din[2][31:0]
      ^ {31'b0, laneq_k512n32_y_out_bind_write[2]}
      ^ laneq_k512n32_y_out_bind_din[3][31:0]
      ^ {31'b0, laneq_k512n32_y_out_bind_write[3]}
      ^ {31'b0, laneq_k512n32_b_mem_read[0]}
      ;
endmodule
