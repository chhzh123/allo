...
void lanesw_k256n16_r0_0(
  ...
  int32_t r127;	// L268
  r127 = 0;	// L269
  l_S_s_0_s: for (int s = 0; s < 262144; s++) {	// L270
  #pragma HLS pipeline II=1
    ...
    if (v295) {	// L572
      ...
      if (v297) {	// L575
        ...
        ap_int<33> v331 = v330;	// L638
        ap_int<33> v332 = 256 - v331;	// L639
        int16_t v333 = v332;	// L640
        int16_t th;	// L641
        th = v333;	// L642
        int16_t v335 = th;	// L643
        ap_int<33> v336 = v335;	// L644
        ap_int<33> v337 = v336 + 256;	// L645
        int16_t v338 = v337;	// L646
        int16_t sig;	// L647
        sig = v338;	// L648
        int32_t v340 = gq;	// L649
        bool v341 = v340 < 0;	// L650
        if (v341) {	// L651
          int16_t v342 = th;	// L652
          ap_int<33> v343 = v342;	// L653
          ap_int<33> v344 = 256 - v343;	// L654
          int16_t v345 = v344;	// L655
          sig = v345;	// L656
        }
        int16_t v346 = sig;	// L658
        int16_t v347 = v346 >> 1;	// L660
        sig = v347;	// L661
        int32_t v348 = gq;	// L662
        int8_t v349 = v348;	// L663
        int8_t g8;	// L664
        g8 = v349;	// L665
        int32_t v351 = uq;	// L666
        int8_t v352 = v351;	// L667
        int8_t u8;	// L668
        u8 = v352;	// L669
        int8_t v354 = g8;	// L670
        int16_t v355 = sig;	// L671
        ap_int<24> v356 = v354;	// L672
        ap_int<24> v357 = v355;	// L673
        ap_int<24> v358 = v356 * v357;	// L674
        #pragma HLS bind_op variable=v358 op=mul impl=fabric
        int16_t v359 = v358;	// L675
        int16_t gs;	// L676
        gs = v359;	// L677
        int16_t v361 = gs;	// L678
        int8_t v362 = u8;	// L679
        ap_int<24> v363 = v361;	// L680
        ap_int<24> v364 = v362;	// L681
        ap_int<24> v365 = v363 * v364;	// L682
        #pragma HLS bind_op variable=v365 op=mul impl=fabric
        int32_t v366 = v365;	// L683
        int32_t h;	// L684
        h = v366;	// L685
        int32_t v368 = h;	// L686
        int32_t v369 = sh2;	// L687
        int32_t v370 = v368 >> v369;	// L688
        h = v370;	// L689
        int32_t v371 = h;	// L690
        bool v372 = v371 < -128;	// L691
        if (v372) {	// L692
          h = -128;	// L693
        }
        int32_t v373 = h;	// L695
        bool v374 = v373 > 127;	// L696
        if (v374) {	// L697
          h = 127;	// L698
        }
        int32_t v375 = h;	// L700
