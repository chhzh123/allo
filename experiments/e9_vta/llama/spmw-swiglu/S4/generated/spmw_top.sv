...
module spmw_top (
  ...
  output wire [31:0] lanesw_k512n32_y_out_bind_din [0:3],
  output wire lanesw_k512n32_y_out_bind_write [0:3],
  input  wire lanesw_k512n32_y_out_bind_full_n [0:3],
  input  wire [63:0] lanesw_k512n32_b_mem_dout [0:3],
  input  wire lanesw_k512n32_b_mem_empty_n [0:3],
  output wire lanesw_k512n32_b_mem_read [0:3]
);
  ...
  endgenerate
  // family lanesw_k512n32_z_in_bind: 4 channel(s), 32-bit, depth 2
  wire [31:0] lanesw_k512n32_z_in_bind_din [0:3];
  wire [31:0] lanesw_k512n32_z_in_bind_dout [0:3];
  wire lanesw_k512n32_z_in_bind_full_n [0:3];
  wire lanesw_k512n32_z_in_bind_write [0:3];
  wire lanesw_k512n32_z_in_bind_empty_n [0:3];
  wire lanesw_k512n32_z_in_bind_read [0:3];
  genvar lanesw_k512n32_z_in_bind_i;
  generate
    for (lanesw_k512n32_z_in_bind_i = 0; lanesw_k512n32_z_in_bind_i < 4; lanesw_k512n32_z_in_bind_i = lanesw_k512n32_z_in_bind_i + 1) begin : g_lanesw_k512n32_z_in_bind
      spmw_fifo #(.DW(32), .DEPTH(2)) u (.clk(ap_clk), .rst_n(ap_rst_n), .din(lanesw_k512n32_z_in_bind_din[lanesw_k512n32_z_in_bind_i]), .full_n(lanesw_k512n32_z_in_bind_full_n[lanesw_k512n32_z_in_bind_i]), .write(lanesw_k512n32_z_in_bind_write[lanesw_k512n32_z_in_bind_i]), .dout(lanesw_k512n32_z_in_bind_dout[lanesw_k512n32_z_in_bind_i]), .empty_n(lanesw_k512n32_z_in_bind_empty_n[lanesw_k512n32_z_in_bind_i]), .read(lanesw_k512n32_z_in_bind_read[lanesw_k512n32_z_in_bind_i]));
    end
  endgenerate
  ...
  pe_r1 u_pe_r1_3_1 (
      ...
      .p_out_din(lanesw_k512n32_z_in_bind_din[1]),
      .p_out_full_n(lanesw_k512n32_z_in_bind_full_n[1]),
      .p_out_write(lanesw_k512n32_z_in_bind_write[1]),
  ...
  pe_r1 u_pe_r1_3_2 (
      ...
      .p_out_din(lanesw_k512n32_z_in_bind_din[2]),
      .p_out_full_n(lanesw_k512n32_z_in_bind_full_n[2]),
      .p_out_write(lanesw_k512n32_z_in_bind_write[2]),
  ...
  pe_r5 u_pe_r5_3_3 (
      ...
      .p_out_din(lanesw_k512n32_z_in_bind_din[3]),
      .p_out_full_n(lanesw_k512n32_z_in_bind_full_n[3]),
      .p_out_write(lanesw_k512n32_z_in_bind_write[3]),
  ...
  pe_r7 u_pe_r7_3_0 (
      ...
      .p_out_din(lanesw_k512n32_z_in_bind_din[0]),
      .p_out_full_n(lanesw_k512n32_z_in_bind_full_n[0]),
      .p_out_write(lanesw_k512n32_z_in_bind_write[0]),
  ...
  // role lanesw_k512n32_r0: 4 instance(s)
  lanesw_k512n32_r0 u_lanesw_k512n32_r0_0 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lanesw_k512n32_b_mem_dout[0]),
      .b_empty_n(lanesw_k512n32_b_mem_empty_n[0]),
      .b_read(lanesw_k512n32_b_mem_read[0]),
      .y_out_din(lanesw_k512n32_y_out_bind_din[0]),
      .y_out_full_n(lanesw_k512n32_y_out_bind_full_n[0]),
      .y_out_write(lanesw_k512n32_y_out_bind_write[0]),
      .z_in_dout(lanesw_k512n32_z_in_bind_dout[0]),
      .z_in_empty_n(lanesw_k512n32_z_in_bind_empty_n[0]),
      .z_in_read(lanesw_k512n32_z_in_bind_read[0]));
  lanesw_k512n32_r0 u_lanesw_k512n32_r0_1 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lanesw_k512n32_b_mem_dout[1]),
      .b_empty_n(lanesw_k512n32_b_mem_empty_n[1]),
      .b_read(lanesw_k512n32_b_mem_read[1]),
      .y_out_din(lanesw_k512n32_y_out_bind_din[1]),
      .y_out_full_n(lanesw_k512n32_y_out_bind_full_n[1]),
      .y_out_write(lanesw_k512n32_y_out_bind_write[1]),
      .z_in_dout(lanesw_k512n32_z_in_bind_dout[1]),
      .z_in_empty_n(lanesw_k512n32_z_in_bind_empty_n[1]),
      .z_in_read(lanesw_k512n32_z_in_bind_read[1]));
  lanesw_k512n32_r0 u_lanesw_k512n32_r0_2 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lanesw_k512n32_b_mem_dout[2]),
      .b_empty_n(lanesw_k512n32_b_mem_empty_n[2]),
      .b_read(lanesw_k512n32_b_mem_read[2]),
      .y_out_din(lanesw_k512n32_y_out_bind_din[2]),
      .y_out_full_n(lanesw_k512n32_y_out_bind_full_n[2]),
      .y_out_write(lanesw_k512n32_y_out_bind_write[2]),
      .z_in_dout(lanesw_k512n32_z_in_bind_dout[2]),
      .z_in_empty_n(lanesw_k512n32_z_in_bind_empty_n[2]),
      .z_in_read(lanesw_k512n32_z_in_bind_read[2]));
  lanesw_k512n32_r0 u_lanesw_k512n32_r0_3 (
      .ap_clk(ap_clk),
      .ap_rst_n(ap_rst_n),
      .b_dout(lanesw_k512n32_b_mem_dout[3]),
      .b_empty_n(lanesw_k512n32_b_mem_empty_n[3]),
      .b_read(lanesw_k512n32_b_mem_read[3]),
      .y_out_din(lanesw_k512n32_y_out_bind_din[3]),
      .y_out_full_n(lanesw_k512n32_y_out_bind_full_n[3]),
      .y_out_write(lanesw_k512n32_y_out_bind_write[3]),
      .z_in_dout(lanesw_k512n32_z_in_bind_dout[3]),
      .z_in_empty_n(lanesw_k512n32_z_in_bind_empty_n[3]),
      .z_in_read(lanesw_k512n32_z_in_bind_read[3]));
endmodule
