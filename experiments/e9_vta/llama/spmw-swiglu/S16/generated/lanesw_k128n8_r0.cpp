...
void lanesw_k128n8_r0_0(
  ...
  int32_t r127;	// L268
  r127 = 0;	// L269
  l_S_s_0_s: for (int s = 0; s < 65536; s++) {	// L270
  #pragma HLS pipeline II=1
    ...
    if (v295) {	// L572
      ...
      if (v297) {	// L575
        ...
        bool v303 = v302 < -128;	// L583
        if (v303) {	// L584
          gq = -128;	// L585
        }
        int32_t v304 = gq;	// L587
        bool v305 = v304 > 127;	// L589
        if (v305) {	// L590
          gq = 127;	// L591
        }
        int32_t v306 = v;	// L593
        int32_t v307 = sh;	// L594
        int32_t v308 = v306 >> v307;	// L595
        int32_t uq;	// L596
        uq = v308;	// L597
        int32_t v310 = uq;	// L598
        bool v311 = v310 < -128;	// L599
        if (v311) {	// L600
          uq = -128;	// L601
        }
        int32_t v312 = uq;	// L603
        bool v313 = v312 > 127;	// L604
        if (v313) {	// L605
          uq = 127;	// L606
        }
        int32_t v314 = gq;	// L608
        int32_t a;	// L609
        a = v314;	// L610
        int32_t v316 = a;	// L611
        bool v317 = v316 < 0;	// L612
        if (v317) {	// L613
          int32_t v318 = a;	// L614
          int32_t v319 = 0 - v318;	// L615
          a = v319;	// L616
        }
        int32_t v320 = a;	// L618
        bool v321 = v320 > 64;	// L620
        if (v321) {	// L621
          a = 64;	// L622
        }
        int32_t v322 = a;	// L624
        ap_int<33> v323 = v322;	// L626
        ap_int<33> v324 = 64 - v323;	// L627
        int8_t v325 = v324;	// L628
        int8_t w;	// L629
        w = v325;	// L630
        int8_t v327 = w;	// L631
        int16_t v328 = v327;	// L632
        int16_t v329 = v328 * v328;	// L633
        #pragma HLS bind_op variable=v329 op=mul impl=fabric
        int16_t v330 = v329 >> 4;	// L636
        ap_int<33> v331 = v330;	// L639
        ap_int<33> v332 = 256 - v331;	// L640
        int16_t v333 = v332;	// L641
        int16_t th;	// L642
        th = v333;	// L643
        int16_t v335 = th;	// L644
        ap_int<33> v336 = v335;	// L645
        ap_int<33> v337 = v336 + 256;	// L646
        int16_t v338 = v337;	// L647
        int16_t sig;	// L648
        sig = v338;	// L649
        int32_t v340 = gq;	// L650
        bool v341 = v340 < 0;	// L651
        if (v341) {	// L652
          int16_t v342 = th;	// L653
          ap_int<33> v343 = v342;	// L654
          ap_int<33> v344 = 256 - v343;	// L655
          int16_t v345 = v344;	// L656
          sig = v345;	// L657
        }
        int16_t v346 = sig;	// L659
        int16_t v347 = v346 >> 1;	// L661
        sig = v347;	// L662
        int32_t v348 = gq;	// L663
        int8_t v349 = v348;	// L664
        int8_t g8;	// L665
        g8 = v349;	// L666
        int32_t v351 = uq;	// L667
        int8_t v352 = v351;	// L668
        int8_t u8;	// L669
        u8 = v352;	// L670
        int8_t v354 = g8;	// L671
        int16_t v355 = sig;	// L672
        ap_int<24> v356 = v354;	// L673
        ap_int<24> v357 = v355;	// L674
        ap_int<24> v358 = v356 * v357;	// L675
        #pragma HLS bind_op variable=v358 op=mul impl=fabric
        int16_t v359 = v358;	// L676
        int16_t gs;	// L677
        gs = v359;	// L678
        int16_t v361 = gs;	// L679
        int8_t v362 = u8;	// L680
        ap_int<24> v363 = v361;	// L681
        ap_int<24> v364 = v362;	// L682
        ap_int<24> v365 = v363 * v364;	// L683
        #pragma HLS bind_op variable=v365 op=mul impl=fabric
        int32_t v366 = v365;	// L684
        int32_t h;	// L685
        h = v366;	// L686
        int32_t v368 = h;	// L687
        int32_t v369 = sh2;	// L688
        int32_t v370 = v368 >> v369;	// L689
        h = v370;	// L690
        int32_t v371 = h;	// L691
        bool v372 = v371 < -128;	// L692
        if (v372) {	// L693
          h = -128;	// L694
        }
        int32_t v373 = h;	// L696
        bool v374 = v373 > 127;	// L697
        if (v374) {	// L698
          h = 127;	// L699
        }
        int32_t v375 = h;	// L701
