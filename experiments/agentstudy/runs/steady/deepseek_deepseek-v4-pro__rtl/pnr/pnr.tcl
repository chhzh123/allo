set files [glob -nocomplain /scratch/hc676/agentstudy/steady/deepseek_deepseek-v4-pro__rtl//sim/*.v /scratch/hc676/agentstudy/steady/deepseek_deepseek-v4-pro__rtl//sim/*.sv]
