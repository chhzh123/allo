set files [glob -nocomplain /scratch/hc676/agentstudy/steady/openai_gpt-5_6-sol__spmw//build/sim/*.v /scratch/hc676/agentstudy/steady/openai_gpt-5_6-sol__spmw//build/sim/*.sv]
