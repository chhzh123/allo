set files [glob -nocomplain /scratch/hc676/agentstudy/steady/deepseek_deepseek-v4-pro__hls//sim/*.v /scratch/hc676/agentstudy/steady/deepseek_deepseek-v4-pro__hls//sim/*.sv]
