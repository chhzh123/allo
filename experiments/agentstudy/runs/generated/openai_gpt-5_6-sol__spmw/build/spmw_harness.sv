...
module spmw_harness (
  ...
  endgenerate
  wire [31:0] drain_west_out_bind_din [0:7];
  wire drain_west_out_bind_write [0:7];
  wire drain_west_out_bind_full_n [0:7];
  genvar g_drain_west_out_bind;
  generate
    for (g_drain_west_out_bind = 0; g_drain_west_out_bind < 8; g_drain_west_out_bind = g_drain_west_out_bind + 1) begin : gen_drain_west_out_bind
      assign drain_west_out_bind_full_n[g_drain_west_out_bind] = 1'b1;
    end
  endgenerate
  ...
  spmw_top dut (
      ...
      .drain_west_out_bind_din(drain_west_out_bind_din),
      .drain_west_out_bind_write(drain_west_out_bind_write),
      .drain_west_out_bind_full_n(drain_west_out_bind_full_n));
  ...
  always @(posedge ap_clk)
    if (!ap_rst_n) sig <= 32'b0;
      ...
      ^ drain_west_out_bind_din[0][31:0]
      ^ {31'b0, drain_west_out_bind_write[0]}
      ^ drain_west_out_bind_din[1][31:0]
      ^ {31'b0, drain_west_out_bind_write[1]}
      ^ drain_west_out_bind_din[2][31:0]
      ^ {31'b0, drain_west_out_bind_write[2]}
      ^ drain_west_out_bind_din[3][31:0]
      ^ {31'b0, drain_west_out_bind_write[3]}
      ^ drain_west_out_bind_din[4][31:0]
      ^ {31'b0, drain_west_out_bind_write[4]}
      ^ drain_west_out_bind_din[5][31:0]
      ^ {31'b0, drain_west_out_bind_write[5]}
      ^ drain_west_out_bind_din[6][31:0]
      ^ {31'b0, drain_west_out_bind_write[6]}
      ^ drain_west_out_bind_din[7][31:0]
      ^ {31'b0, drain_west_out_bind_write[7]}
      ;
endmodule
