...
add_files -fileset constrs_1 /scratch/hc676/e4_pnr/fixed_8/clock.xdc
...
report_utilization -file /scratch/hc676/e4_pnr/fixed_8/util_synth.rpt
stage opt { opt_design }
stage place { place_design }
stage physopt { phys_opt_design }
stage route { route_design }
report_utilization -file /scratch/hc676/e4_pnr/fixed_8/util.rpt
report_utilization -hierarchical -hierarchical_depth 1 -file /scratch/hc676/e4_pnr/fixed_8/util_hier.rpt
report_timing_summary -file /scratch/hc676/e4_pnr/fixed_8/timing.rpt
report_route_status -file /scratch/hc676/e4_pnr/fixed_8/route.rpt
