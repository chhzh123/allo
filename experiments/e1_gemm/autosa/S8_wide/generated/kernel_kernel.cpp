...
/* Module Definition */
void A_IO_L3_in_serialize(A_t64 *A, hls::stream<A_t8> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
  ...
  #pragma HLS PIPELINE II=1
    ...
    for (ap_uint<4> p = 0; p < 8; p++) {
      fifo_data = mem_data(63, 0);
      mem_data = mem_data >> 64;
...
/* Module Definition */
void B_IO_L3_in_serialize(B_t64 *B, hls::stream<B_t8> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out(hls::stream<int> &fifo_C_drain_out, hls::stream<int> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_serialize(C_t16 *C, hls::stream<int> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
{
#pragma HLS INTERFACE m_axi port=A offset=slave bundle=gmem_A depth=1
#pragma HLS INTERFACE m_axi port=B offset=slave bundle=gmem_B depth=1
#pragma HLS INTERFACE m_axi port=C offset=slave bundle=gmem_C depth=4
...
#pragma HLS DATAFLOW
  ...
  /* C_drain_IO_L3_out_serialize fifo */ hls::stream<int> fifo_C_drain_C_drain_IO_L3_out_serialize;
