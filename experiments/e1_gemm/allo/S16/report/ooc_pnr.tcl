foreach f [glob -nocomplain /scratch/hc676/e1_allo_beats/S16/prj/sol/syn/verilog/*.v]  { read_verilog $f }
foreach f [glob -nocomplain /scratch/hc676/e1_allo_beats/S16/prj/sol/syn/verilog/*.sv] { read_verilog -sv $f }
