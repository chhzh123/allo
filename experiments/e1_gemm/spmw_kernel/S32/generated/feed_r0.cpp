...
void feed_r0_0(
  ...
  hls::stream< hls::vector< int8_t, 32 > >& v1,
  hls::stream< int8_t >& v2,
  hls::stream< hls::vector< int8_t, 32 > >& v3
) {	// L2
  ...
  l_S_k_0_k: for (int k = 0; k < 32; k++) {	// L9
    int8_t v9[32];
    {
      hls::vector< int8_t, 32 > _vec = v1.read();
...
void top(
  ...
  #pragma HLS dataflow
  // Stream of vectors: each vector packs int8_t array[32] into hls::vector<int8_t, 32>
  hls::stream< hls::vector< int8_t, 32 > > v13;
  #pragma HLS stream variable=v13 depth=2	// L20
  hls::stream< int8_t > v14;
  #pragma HLS stream variable=v14 depth=2	// L21
  // Stream of vectors: each vector packs int8_t array[32] into hls::vector<int8_t, 32>
  hls::stream< hls::vector< int8_t, 32 > > v15;
