...
#include <stdint.h>
using namespace std;
float _st_tw[4][2][2] = {1.000000e+00, 0.000000e+00, 9.238795e-01, -3.826834e-01, 7.071068e-01, -7.071068e-01, 3.826834e-01, -9.238795e-01, 6.123234e-17, -1.000000e+00, -3.826834e-01, -9.238795e-01, -7.071068e-01, -7.071068e-01, -9.238795e-01, -3.826834e-01};	// L2
void delay4_r0_0(
  ...
  ell = v6;	// L14
  float ar[4];	// L15
  for (int v9 = 0; v9 < 4; v9++) {	// L16
    ar[v9] = (float)0.000000;	// L16
  }
  float ai[4];	// L17
  for (int v11 = 0; v11 < 4; v11++) {	// L18
    ai[v11] = (float)0.000000;	// L18
  }
  float br[4];	// L19
  for (int v13 = 0; v13 < 4; v13++) {	// L20
    br[v13] = (float)0.000000;	// L20
  }
  float bi[4];	// L21
  for (int v15 = 0; v15 < 4; v15++) {	// L22
    bi[v15] = (float)0.000000;	// L22
  }
  l_S__b_0__b: for (int _b = 0; _b < 544; _b++) {	// L23
    l_S_h_0_h: for (int h = 0; h < 2; h++) {	// L24
      l_S_c_0_c: for (int c = 0; c < 4; c++) {	// L25
        float v19[2];
        {
