...
void perm3_r0_0(
  ...
  float vr[8];	// L8
  for (int v5 = 0; v5 < 8; v5++) {	// L9
    vr[v5] = (float)0.000000;	// L9
  }
  float vi[8];	// L10
  for (int v7 = 0; v7 < 8; v7++) {	// L11
...
void top(
  ...
  perm3_r0_0(v70, v72, v71, v73);	// L106
}
