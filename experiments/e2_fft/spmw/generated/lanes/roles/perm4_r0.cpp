...
void perm4_r0_0(
  ...
  float vi[4];	// L10
  for (int v7 = 0; v7 < 4; v7++) {	// L11
    vi[v7] = (float)0.000000;	// L11
  }
  float ur[4];	// L12
  for (int v9 = 0; v9 < 4; v9++) {	// L13
    ur[v9] = (float)0.000000;	// L13
  }
  float ui[4];	// L14
  for (int v11 = 0; v11 < 4; v11++) {	// L15
...
void top(
  ...
  perm4_r0_0(v70, v72, v71, v73);	// L106
}
