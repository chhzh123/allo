...
void perm2_r0_0(
  ...
  float vr[16];	// L8
  for (int v5 = 0; v5 < 16; v5++) {	// L9
    vr[v5] = (float)0.000000;	// L9
  }
  float vi[16];	// L10
  for (int v7 = 0; v7 < 16; v7++) {	// L11
    vi[v7] = (float)0.000000;	// L11
  }
  float ur[16];	// L12
  for (int v9 = 0; v9 < 16; v9++) {	// L13
    ur[v9] = (float)0.000000;	// L13
  }
  float ui[16];	// L14
  for (int v11 = 0; v11 < 16; v11++) {	// L15
...
void top(
  ...
  perm2_r0_0(v70, v72, v71, v73);	// L106
}
