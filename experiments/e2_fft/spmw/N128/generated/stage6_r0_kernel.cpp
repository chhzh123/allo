...
void stage6_r0_0(
  ...
  float ar[1];	// L10
  for (int v4 = 0; v4 < 1; v4++) {	// L11
    ar[v4] = (float)0.000000;	// L11
  }
  float ai[1];	// L12
  for (int v6 = 0; v6 < 1; v6++) {	// L13
    ai[v6] = (float)0.000000;	// L13
  }
  float br[1];	// L14
  for (int v8 = 0; v8 < 1; v8++) {	// L15
    br[v8] = (float)0.000000;	// L15
  }
  float bi[1];	// L16
  for (int v10 = 0; v10 < 1; v10++) {	// L17
    bi[v10] = (float)0.000000;	// L17
  }
  l_S__b_0__b: for (int _b = 0; _b < 2176; _b++) {	// L18
    l_S_h_0_h: for (int h = 0; h < 2; h++) {	// L19
      l_S_c_0_c: for (int c = 0; c < 1; c++) {	// L20
        float v14[2];
        {
