...
void stage4_r0_0(
  ...
  float ar[4];	// L10
  for (int v4 = 0; v4 < 4; v4++) {	// L11
    ar[v4] = (float)0.000000;	// L11
  }
  float ai[4];	// L12
  for (int v6 = 0; v6 < 4; v6++) {	// L13
    ai[v6] = (float)0.000000;	// L13
  }
  float br[4];	// L14
  for (int v8 = 0; v8 < 4; v8++) {	// L15
    br[v8] = (float)0.000000;	// L15
  }
  float bi[4];	// L16
  for (int v10 = 0; v10 < 4; v10++) {	// L17
    bi[v10] = (float)0.000000;	// L17
  }
  l_S__b_0__b: for (int _b = 0; _b < 544; _b++) {	// L18
    l_S_h_0_h: for (int h = 0; h < 2; h++) {	// L19
      l_S_c_0_c: for (int c = 0; c < 4; c++) {	// L20
        float v14[2];
        {
