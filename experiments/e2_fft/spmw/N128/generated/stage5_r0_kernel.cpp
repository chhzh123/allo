...
void stage5_r0_0(
  ...
  float ai[2];	// L12
  for (int v6 = 0; v6 < 2; v6++) {	// L13
    ai[v6] = (float)0.000000;	// L13
  }
  float br[2];	// L14
  for (int v8 = 0; v8 < 2; v8++) {	// L15
    br[v8] = (float)0.000000;	// L15
  }
  float bi[2];	// L16
  for (int v10 = 0; v10 < 2; v10++) {	// L17
    bi[v10] = (float)0.000000;	// L17
  }
  l_S__b_0__b: for (int _b = 0; _b < 1088; _b++) {	// L18
    l_S_h_0_h: for (int h = 0; h < 2; h++) {	// L19
      l_S_c_0_c: for (int c = 0; c < 2; c++) {	// L20
        float v14[2];
        {
