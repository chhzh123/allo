...
void reorder_r0_0(
  ...
  l_S_b_1_b: for (int b = 0; b < 33; b++) {	// L17
    ...
    int32_t other;	// L26
    other = v18;	// L27
    l_S_i_1_i: for (int i = 0; i < 1024; i++) {	// L28
      float v21[2];
      {
        hls::vector< float, 2 > _vec = v0.read();
        for (int _iv0 = 0; _iv0 < 2; ++_iv0) {
  ...
  int32_t last;	// L62
  last = 0;	// L63
  l_S_i_3_i1: for (int i1 = 0; i1 < 1024; i1++) {	// L64
    float y2[2];	// L65
