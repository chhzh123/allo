...
void load_buf0(
  ...
  l_S_load_buf0_load_buf0_l_0: for (int load_buf0_l_0 = 0; load_buf0_l_0 < 256; load_buf0_l_0++) {	//
...
void load_buf1(
  ...
  l_S_load_buf1_load_buf1_l_0: for (int load_buf1_l_0 = 0; load_buf1_l_0 < 256; load_buf1_l_0++) {	//
  #pragma HLS pipeline II=1 rewind
...
void load_buf2(
  ...
  l_S_load_buf2_load_buf2_l_0: for (int load_buf2_l_0 = 0; load_buf2_l_0 < 128; load_buf2_l_0++) {	//
  #pragma HLS pipeline II=1 rewind
...
void load_buf3(
  ...
  l_S_load_buf3_load_buf3_l_0: for (int load_buf3_l_0 = 0; load_buf3_l_0 < 128; load_buf3_l_0++) {	//
  #pragma HLS pipeline II=1 rewind
...
void store_res0(
  ...
  l_S_store_res0_store_res0_l_0: for (int store_res0_l_0 = 0; store_res0_l_0 < 256; store_res0_l_0++) {	//
  #pragma HLS pipeline II=1 rewind
...
void store_res1(
  ...
  l_S_store_res1_store_res1_l_0: for (int store_res1_l_0 = 0; store_res1_l_0 < 256; store_res1_l_0++) {	//
  #pragma HLS pipeline II=1 rewind
...
void fft(
  ...
  #pragma HLS interface m_axi port=v24 offset=slave bundle=gmem0 depth=256
  #pragma HLS interface m_axi port=v25 offset=slave bundle=gmem1 depth=256
  #pragma HLS interface m_axi port=v26 offset=slave bundle=gmem2 depth=128
  #pragma HLS interface m_axi port=v27 offset=slave bundle=gmem3 depth=128
  float buf0[256];	//
  load_buf0(v24, buf0);	//
  float buf1[256];	//
  load_buf1(v25, buf1);	//
