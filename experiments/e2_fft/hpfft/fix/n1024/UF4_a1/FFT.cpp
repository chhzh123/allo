...
void reverse_input_stream_UF4 (
    ...
    static complex<float> data_rev_stream_0[FFT_NUM/(UF*2)];
    static complex<float> data_rev_stream_1[FFT_NUM/(UF*2)];
    static complex<float> data_rev_stream_2[FFT_NUM/(UF*2)];
    static complex<float> data_rev_stream_3[FFT_NUM/(UF*2)];
    static complex<float> data_rev_stream_4[FFT_NUM/(UF*2)];
    static complex<float> data_rev_stream_5[FFT_NUM/(UF*2)];
    static complex<float> data_rev_stream_6[FFT_NUM/(UF*2)];
    static complex<float> data_rev_stream_7[FFT_NUM/(UF*2)];
